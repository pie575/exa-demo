---
title: "Empieza a desarrollar con Exa"
sidebarTitle: "Descripción general"
description: "Una potente herramienta de búsqueda web diseñada para agentes. Todo está optimizado para darte resultados precisos y eficientes en el uso de tokens."
mode: "wide"
timestamp: false
...
export const ApiCards = ({only}) => {
  ...
  const cards = [{
    id: "search",
    title: "Search",
    body: "Datos fiables en tiempo real con contenido de páginas optimizado para tokens",
    ...
    alt: "Hoja de cálculo de empresas enriquecida con asociaciones, casos de clientes y uso de servicios en la nube"
  }, {
    id: "search-deep",
    title: "Deep Search",
    body: "Search que razona a partir de múltiples fuentes y devuelve resultados estructurados",
    href: "/docs/search/deep-search",
    image: "/docs/images/home/api-search-deep.webp",
    alt: "Consulta de Deep Search que devuelve JSON estructurado sobre empresas biotecnológicas"
  }, {
    id: "contents",
    title: "Contents",
    ...
    id: "monitors",
    title: "Monitores",
    body: "Búsquedas programadas que supervisan la web y envían nuevos resultados",
    href: "/docs/monitors/quickstart",
    image: "/docs/images/home/api-monitors.webp",
    alt: "Monitor llamado «Lanzamientos y noticias de Anthropic» que se ejecuta todos los días",
    hidden: true
  }];
  ...
  <div className="docs-home-try">
    ...
    <div className="docs-home-try-grid">
      ...
      <div className="docs-home-apis" role="tablist" aria-label="API">
        ...
        <label htmlFor="docs-home-api-deep">Obtén resultados estructurados</label>
        <label htmlFor="docs-home-api-tools">Dale búsqueda web a un LLM</label>
        <label htmlFor="docs-home-api-agent">Crea una lista documentada</label>
