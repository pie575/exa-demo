...
description: "Una potente herramienta de búsqueda web diseñada para agentes. Todo está optimizado para ofrecerte resultados precisos con un uso eficiente de tokens."
mode: "wide"
timestamp: false
...
export const ApiCards = ({only}) => {
  ...
  const cards = [{
    ...
    id: "agent",
    title: "Agent",
    body: "Agentes asíncronos para investigación profunda, creación de listas y enrichment",
    href: "/docs/agent/quickstart",
    image: "/docs/images/home/api-agent.webp",
    alt: "Hoja de cálculo de empresas enriquecida con alianzas, casos de clientes y uso de la nube"
  }, {
    id: "search-deep",
    title: "Deep Search",
    body: "Búsqueda que analiza fuentes y devuelve salida estructurada",
  ...
  <div className="docs-home-try">
    ...
    <div className="docs-home-try-grid">
      ...
      <div className="docs-home-apis" role="tablist" aria-label="API">
        ...
        <label htmlFor="docs-home-api-deep">Obtener una salida estructurada</label>
        <label htmlFor="docs-home-api-tools">Dar búsqueda web a un LLM</label>
