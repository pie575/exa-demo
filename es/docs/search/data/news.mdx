...
icon: "newspaper"
description: "Encuentra la actualidad informativa, cobertura del sector y temas emergentes con Exa Search."
---
...
Usa Exa Search para acceder a reportajes de grandes publicaciones, prensa especializada y medios de nicho. Los artículos nuevos se pueden buscar a los pocos minutos de publicarse. Combina una query en lenguaje natural con filtros de fecha cuando la ventana de publicación sea un requisito ineludible.

<div id="use-it-for">
  ## Úsalo para
</div>

* Investigación de mercado e inversiones
...
<div id="follow-a-developing-policy-story">
  ### Seguir una noticia política en desarrollo
</div>
...
Indica el tipo de fuente cuando quieras obtener análisis de profesionales del sector y no cobertura periodística general.
...
Incluye el formato y el tema en la query. De este modo, la search sigue abierta a páginas de episodios y transcripciones de toda la web.

<PlaygroundQuery query="podcast episodes where founders discuss pricing strategy mistakes" />

<div id="research-adverse-media">
  ### Investigar noticias adversas
</div>

Describe tanto la señal negativa como el tipo de entidad que investigas. Evita reducir la query al nombre de la empresa seguido de la palabra «noticias».
