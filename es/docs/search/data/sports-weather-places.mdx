...
### Pide la liga, el equipo y el momento {#ask-for-the-league-team-and-time}
...
### Nombra el lugar y el día {#name-the-place-and-day}
...
### Combina pronósticos con cobertura periodística {#combine-forecasts-with-reporting}
...
### Describe el lugar como se lo preguntarías a alguien del lugar {#describe-the-place-like-you-would-ask-a-local}
