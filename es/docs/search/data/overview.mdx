...
Exa busca en la web pública y en determinadas fuentes de datos privadas, con una cobertura que se actualiza de forma continua. Incluye:
...
<AccordionGroup>
  <Accordion title="Noticias" icon="newspaper">
    <Card title="Guía de noticias" icon="newspaper" href="/es/docs/search/data/news" cta="Leer guía" arrow="true">
      Explora casos de uso, ejemplos y prácticas recomendadas para la búsqueda de noticias.
    </Card>
    ...
    Transcripts de pódcast y video:
  ...
  <Accordion title="Código y documentación" icon="code">
    <Card title="Guía de código y documentación" icon="code" href="/es/docs/search/data/code" cta="Leer la guía" arrow="true">
      Explora casos de uso, ejemplos y buenas prácticas de la búsqueda de código.
    </Card>
  ...
  <Accordion title="Empresas y personas" icon="users">
    ...
    Investigación de empresas y de sus responsables en una sola consulta:
  ...
  <Accordion title="Mercados financieros" icon="chart-line">
    ...
    Documentos presentados ante la SEC, llamadas de resultados e informes regulatorios internacionales:
    ...
    Datos económicos publicados y estadísticas gubernamentales:
  ...
  <Accordion title="Publicaciones de investigación" icon="book-open">
    <Card title="Guía de publicaciones de investigación" icon="book-open" href="/es/docs/search/data/research" cta="Leer la guía" arrow="true">
      Explora casos de uso de investigación sobre artículos, patentes, estudios clínicos y regulación.
    </Card>
...
Estas guías abordan patrones de datos habituales, pero Exa también busca en el resto de la web pública, abarcando numerosos sitios, formatos e idiomas.