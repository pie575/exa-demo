...
icon: "shield"
description: "Encuentra vulnerabilidades, avisos de seguridad, informes de amenazas y documentación de confianza con Exa Search."
---
...
Usa Exa Search para consultar registros de vulnerabilidades, avisos de proveedores e investigaciones sobre amenazas de las fuentes que los equipos de seguridad ya consultan.
...
<div id="triage-a-vulnerability-class">
  ### Clasificar una categoría de vulnerabilidad
</div>
...
<Card title="Iniciar una tarea de Agent" icon="bot" href="/es/docs/agent/quickstart" cta="Abrir la guía de Agent" arrow="true">
  Evalúa a un proveedor a partir de avisos de seguridad, reportes de brechas y páginas de confianza, o reúne datos normalizados de vulnerabilidades.
</Card>