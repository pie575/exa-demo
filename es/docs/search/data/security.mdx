...
sidebarTitle: "Ciberseguridad"
icon: "shield"
description: "Encuentra vulnerabilidades, avisos, informes de amenazas y documentación de confianza con Exa Search."
---
...
Usa Exa Search para obtener registros de vulnerabilidades, avisos de vendors e investigación de amenazas desde las fuentes que los equipos de seguridad ya consultan.
...
### Clasificar una clase de vulnerabilidad {#triage-a-vulnerability-class}
...
Describe el estado de explotación y la clase de producto en lugar de un único ID de CVE.
...
Indica el tipo de documento y la categoría de vendor.
