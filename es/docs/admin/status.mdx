...
description: "Disponibilidad en tiempo real, incidentes activos e historial de disponibilidad de los servicios de Exa."
...
Exa publica la disponibilidad del servicio en [status.exa.ai](https://status.exa.ai): el estado actual de la Search API, Websets y Exa MCP, los incidentes activos con actualizaciones a medida que evolucionan y 90 días de historial de disponibilidad.
