...
En Exa nos tomamos en serio la seguridad y la privacidad de los datos. Nos enorgullece contar con la certificación SOC 2 Type II, que refleja nuestro compromiso de mantener prácticas y controles rigurosos de seguridad de la información.
...
Para cumplir con las sanciones y restricciones comerciales, Exa bloquea el acceso a la API desde países y regiones sancionados o restringidos por otros motivos, entre ellos Crimea, Cuba, Irán, Corea del Norte, Rusia, Siria, Ucrania y Venezuela.
