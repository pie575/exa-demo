...
<Update label="July 23, 2026" rss={{ title: "Publication research" }}>
  <div id="publication-research">
    ## Investigación sobre publicaciones
  </div>
...
<Update label="February 2, 2026" rss={{ title: "Highlights, frescura del contenido y novedades de MCP" }}>
  <div id="highlights-content-freshness-and-mcp-updates">
    ## Highlights, frescura del contenido y novedades de MCP
  </div>
...
<Update label="August 4, 2025" rss={{ title: "Soporte de filtros por ruta de dominio" }}>
  <div id="domain-path-filter-support">
    ## Soporte de filtros por ruta de dominio
  </div>
...
<Update label="July 30, 2025" rss={{ title: "Soporte de filtros por geolocalización" }}>
  <div id="geolocation-filter-support">
    ## Soporte de filtros por geolocalización
  </div>
...
<Update label="July 21, 2025" rss={{ title: "Score Deprecation in Auto Search" }}>
  <div id="score-deprecation-in-auto-search">
    ## Deprecación de score en la búsqueda Auto
  </div>
...
<Update label="May 22, 2025" rss={{ title: "contenido Endpoint Status Changes" }}>
  <div id="contents-endpoint-status-changes">
    ## Cambios de estado en el endpoint contenido
  </div>
...
<Update label="December 11, 2024" rss={{ title: "Auto search as Default" }}>
  <div id="auto-search-as-default">
    ## La búsqueda Auto como opción por defecto
  </div>
