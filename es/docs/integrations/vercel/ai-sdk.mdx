...
description: "Añade Exa web search a tus aplicaciones con AI SDK mediante el paquete @exalabs/ai-sdk."
icon: "/docs/images/sidebar-icons/vercel.svg"
---

Usa el paquete `@exalabs/ai-sdk` para añadir Exa web search a las aplicaciones creadas con el AI SDK de Vercel. Solo tienes que proporcionar una API key de Exa y la herramienta `webSearch()` se encargará de las solicitudes de búsqueda de tu modelo.
...
* `maxAgeHours`: el valor de reserva de caché predeterminado; configura esta opción cuando necesites una frescura más estricta
...
| `contents.maxAgeHours`                                 | Usa el contenido en caché solo si no supera la antigüedad indicada; en caso contrario, usa livecrawl. |
