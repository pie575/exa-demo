...
## enrichment de datos {#data-enrichment}
...
### Enriquecer con información del CEO o fundador {#enrich-with-ceofounder-info}
...
### Elegir el nivel de paralelismo {#choosing-parallelism}
