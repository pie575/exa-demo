...
Instala el plugin de Exa una sola vez para dar a Codex y ChatGPT acceso a la web en tiempo real a través de Exa. Busca información actualizada, lee las fuentes que de verdad importan y realiza investigaciones más profundas sin salir de tu conversación o de tu sesión de programación.
...
<Steps>
  ...
  <Step title="Inicia una nueva sesión">
    Las skills se cargan en los chats y las sesiones de CLI que se inicien después de la instalación, así que abre una nueva y pide algo que requiera consultar la web.
  </Step>
</Steps>
...
<div id="build-with-whats-on-the-web-right-now">
  ## Crea con lo que hay en la web ahora mismo
</div>
...
Lo mismo aplica siempre que la respuesta pueda estar fuera de tu repositorio:
...
```text theme={null}
Compara los servicios gestionados, las licencias y los precios de las principales
bases de datos vectoriales de código abierto. Usa fuentes primarias actuales y cítalas.
```

En lugar de depender únicamente de la información que ya tiene en contexto, ChatGPT puede usar Exa para encontrar y leer las fuentes que necesita para la tarea.

Úsalo para análisis de la competencia, investigación técnica, mapeo de mercado, investigación de empresas o cualquier otro caso en el que la respuesta esté repartida por la web.
...
[Exa MCP](/es/docs/get-started/exa-mcp) proporciona a Codex y a ChatGPT las herramientas para acceder a Exa. Es el puente entre el agente y las capacidades de búsqueda e investigación de Exa.
