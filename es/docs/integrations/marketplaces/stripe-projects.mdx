...
description: "Integra Exa desde tu terminal con la CLI de Stripe Projects."
icon: "/docs/images/sidebar-icons/stripe.svg"
---

[Stripe Projects](https://projects.dev) te permite, a ti y a tus agentes de programación, aprovisionar servicios de terceros desde la terminal, sin paneles de control ni copiar y pegar keys. Un solo comando crea una cuenta de Exa y sincroniza una API key en tu proyecto.
...
Tu archivo `.env` ahora contiene una `EXA_API_KEY`. Los [SDKs de Exa](/es/docs/sdks/quickstart) y el [Quickstart](/es/docs/search/quickstart) leen esta variable automáticamente, así que tu código funciona sin necesidad de cambios.

<Info>
  La key se aprovisiona en una cuenta de Exa de tu propiedad. Gestiona el uso, las keys y la facturación en cualquier momento desde el [Panel de Exa](https://dashboard.exa.ai).
</Info>
...
`stripe projects link` abre Exa para que puedas autenticarte y vincular tu equipo con tu cuenta de Stripe. Puedes abrir en cualquier momento el Panel de Exa vinculado con `stripe projects open exa`.
...
* [Inicio rápido](/es/docs/search/quickstart): realiza tu primera search de Exa con nuestros SDK.
* [Documentación de Stripe Projects](https://docs.stripe.com/projects): referencia completa de la CLI, entornos y facturación.
* [Panel de Exa](https://dashboard.exa.ai): gestiona las API keys, el uso y la facturación.
