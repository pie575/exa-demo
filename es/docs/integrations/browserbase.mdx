---
title: "Browserbase"
description: "Combina la búsqueda de empresas de Exa con la automatización del navegador de Browserbase para flujos de trabajo de postulación a empleos."
icon: "/docs/images/sidebar-icons/browserbase.svg"
---

Usa Exa para encontrar empresas y páginas de empleo, y luego Browserbase y Stagehand para inspeccionar esas páginas e interactuar con ellas.

## Instalación {#install}

Instala los paquetes que utiliza la plantilla de Browserbase Exa:
...
## Buscar e interactuar con una página {#search-and-interact-with-a-page}

El siguiente ejemplo sigue el flujo de trabajo de la plantilla: buscar empresas, localizar su página de empleo, abrirla en una sesión de Browserbase, extraer la descripción del puesto y dejar que un agente de Stagehand interactúe con la página.
