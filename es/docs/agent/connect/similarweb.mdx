---
title: "Similarweb"
description: "Obtén estimaciones de tráfico de sitios web, rankings globales y descubrimiento de competidores."
icon: "/docs/images/sidebar-icons/similarweb.svg"
---

[Similarweb](https://www.similarweb.com) es una de las principales fuentes de inteligencia
de mercado digital. Modela el tráfico y el engagement de millones de sitios web y
aplicaciones, e incluye visitas estimadas, fuentes de tráfico, datos demográficos de la audiencia y el
conjunto de competidores en torno a cualquier dominio.
...
* Identificar los competidores de un dominio y los sitios con audiencias superpuestas.
...
Similarweb factura en créditos de datos a `$0.30 / credit`, y cada llamada se
cobra según los créditos que Similarweb informa para ella. Los créditos aumentan
con los datos devueltos, aproximadamente un crédito por cada punto de datos
(métrica × fila × mes), por lo que el precio de una llamada lo determinan sus
parámetros:
...
| Principales sitios de referencia   | 3 por sitio de referencia devuelto (1–5)                                                       |
| Principales países                 | 3 por país devuelto (1–5)                                                                      |
| Páginas principales                | 2 por página devuelta (1–7)                                                                    |
| Palabras clave principales         | 1–10 (alrededor de 1 por cada 100 puntos de datos de palabras clave; 50 palabras clave son ~7) |
...
Las llamadas que no devuelven datos (un dominio desconocido o con poco tráfico,
una palabra clave sin volumen de búsqueda) son gratuitas. `numResults` y `months`
definen cuántos puntos de datos pagas, así que mantenlos en el mínimo que la
tarea requiera.
...
* [Fiber.ai](/es/docs/agent/connect/fiber): convierte los competidores descubiertos en registros de empresa enriquecidos.
...
<Columns cols={2}>
  ...
  <Card title="Combina proveedores" icon="blend" href="/es/docs/agent/connect/combining-providers" cta="Leer la guía" arrow="true">
    Adjunta hasta cinco partners a un mismo run y formula la consulta para que se activen todos.
  </Card>
  ...
  <Card title="Consigue una API key" icon="key" href="https://dashboard.exa.ai/api-keys" cta="Crear una key" arrow="true">
    Crea una key en el panel y ejecuta tal cual el ejemplo de esta página. Las cuentas nuevas empiezan con créditos gratis.
  </Card>
</Columns>