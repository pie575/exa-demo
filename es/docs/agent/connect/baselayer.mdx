---
title: "Baselayer"
description: "Verifica empresas de EE. UU. y obtén datos KYB: directivos, registros y puntuaciones de riesgo."
...
* Onboarding de KYB y verificación de proveedores y clientes.
* Debida diligencia sobre directivos, registros y estructura societaria.
...
| Consulta de empresa / directivos / registros / búsqueda inversa de directivos | Gratis (lecturas de una búsqueda previa)    |
...
* [Financial Datasets](/es/docs/agent/connect/financialdatasets): añade cobertura de noticias recientes sobre entidades públicas.
