---
title: "Particle"
description: "Busca transcripts de pódcasts con atribución de hablante y marcas de tiempo."
icon: "/docs/images/sidebar-icons/particle.svg"
---

El Podcast Intelligence de [Particle](https://particle.news) indexa más de 100.000 programas,
transcritos por completo, diarizados, con hablantes identificados, etiquetados y enriquecidos con metadatos
a los pocos minutos de su emisión, lo que permite buscar dentro de las conversaciones habladas. Cada resultado es una
ventana del transcript atribuida a un hablante y con marcas de tiempo.
