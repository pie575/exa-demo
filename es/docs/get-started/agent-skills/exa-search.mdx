...
Usa este skill para enseñarle a tu agente a llamar a Exa Search con cURL o HTTP sin procesar, siguiendo las mejores prácticas.
...
Goal:
- Install the exa-search skill so my coding agente can use it to llamar Exa Search directly with cURL or HTTP sin procesar.
