...
description: "Obtén una API key y luego usa Exa desde tu código o tu agente."
boost: 3
---
...
<div className="docs-quickstart-section docs-quickstart-auth">
  ...
  <Steps>
    <Step title="Visita el Dashboard de Exa">
...
<div className="docs-quickstart-section">
  ...
  <Columns cols={2}>
    ...
    <Card title="Conecta tu agente" icon="plug" href="/es/docs/get-started/exa-mcp" cta="Configurar Exa MCP">
      Conecta ChatGPT, Claude, Codex o Cursor a las herramientas de search e investigación
      de Exa. No se necesita API key.
    </Card>
  </Columns>
...
<div className="docs-quickstart-section">
  ...
  <Columns cols={2}>
    ...
    <Card title="Exa MCP" icon="plug" href="/es/docs/get-started/exa-mcp" cta="Leer guía" arrow="true">
      Conecta cualquier cliente MCP a las herramientas de búsqueda web, obtención de páginas y Exa Agent
      de Exa.
    </Card>
  </Columns>
</div>