---
title: "Quickstart para desarrolladores"
sidebarTitle: "Quickstart"
description: "Obtén una API key y luego usa Exa desde tu código o desde tu agente."
boost: 3
---

<div className="docs-quickstart-section docs-quickstart-auth">
  ## 1. Obtén una API key {#1-get-an-api-key}
...
<div className="docs-quickstart-section">
  ## 2. Elige cómo usarás Exa {#2-choose-how-youll-use-exa}
  ...
  <Columns cols={2}>
    <Card title="Llama a las APIs" icon="code" href="#3-install-an-sdk" cta="Instala un SDK">
      Usa Search, Contents y Exa Agent desde tu propio código. Instala un SDK
      más abajo y haz tu primera solicitud.
    </Card>

    <Card title="Conecta tu agente" icon="plug" href="/es/docs/get-started/exa-mcp" cta="Configura Exa MCP">
  ...
  | [Deep Search](/es/docs/search/deep-search) | Búsqueda de mayor calidad en la que un LLM encuentra mejores resultados de forma iterativa |
  | [Agent](/es/docs/agent/quickstart)         | Investigación asíncrona de larga duración, creación de listas, enrichment o informes       |
  | [Contents](/es/docs/contents/quickstart)   | Extraer el contenido de páginas cuando ya tienes la(s) URL(s)                              |
</div>
...
<div className="docs-quickstart-section">
  ...
  <Columns cols={2}>
    ...
    <Card title="Exa MCP" icon="plug" href="/es/docs/get-started/exa-mcp" cta="Leer la guía" arrow="true">
      Conecta cualquier MCP client a las herramientas de búsqueda web, obtención de
      páginas y Exa Agent de Exa.
    </Card>
  </Columns>
</div>