...
verifica entidades de EE. UU. contra datos oficiales de registro y riesgo.
...
| Consulta de empresa / directivos / registrations / búsqueda inversa de directivo | Gratis (lecturas de una búsqueda previa)    |
| Search de gravámenes                                                         | `$2.00 / state searched`                    |
| Search de litigios                                                           | `$1.00 / category (litigation, bankruptcy)` |
| Revisión de watchlist                                                        | `$0.10 – $0.25 / list requested`            |
...
$4.00, una revisión de watchlist con las seis listas admitidas cuesta $1.35, y una llamada de
