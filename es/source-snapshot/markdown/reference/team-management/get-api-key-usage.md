...
El endpoint Get API Key Usage te permite obtener análisis detallados de facturación y uso de una API key específica durante un periodo determinado. Este endpoint devuelve los datos de costos del sistema de facturación de Exa, lo que ofrece una visión fiable de lo que se te factura por esa API key.
...
* **cost&#95;breakdown**: Arreglo con el desglose de costos por tipo de precio; cada elemento contiene:
...
* Configurar alertas automáticas basadas en umbrales de uso
