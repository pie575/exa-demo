...
Las skills de Exa enseñan a los agentes de programación a buscar, recuperar contenido y desarrollar con las APIs de Exa. Encuéntralas en el repositorio de código abierto [exa-labs/agent-skills](https://github.com/exa-labs/agent-skills).

Cada skill contiene archivos markdown que siguen el estándar abierto [Skills de agente](https://agentskills.io), por lo que los mismos archivos se pueden instalar en cualquier agente compatible.
...
<Note>
  Configura tu key como `EXA_API_KEY` en el entorno de tu agente.
</Note>
