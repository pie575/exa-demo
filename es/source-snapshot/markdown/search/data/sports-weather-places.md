...
<div id="sports-weather-places">
  # Deportes, clima y lugares
</div>

> Encuentra datos deportivos en vivo, pronósticos del tiempo y lugares cercanos con Exa Search.
...
Usa Exa Search para obtener datos deportivos en vivo, pronósticos del tiempo e información local sin integrar una API distinta para cada caso. Haz una pregunta en lenguaje natural que incluya el equipo, el lugar y el intervalo de tiempo que te interesan.
...
<Tabs>
  <Tab title="Deportes" icon="trophy">
    ...
    * **Clasificaciones**: tablas de posiciones actuales, desglosadas por conferencia o división
    * **Calendarios**: resultados pasados y próximos partidos de una liga o equipo

    La cobertura incluye la NBA, WNBA, NFL, MLB, NHL, MLS, baloncesto y fútbol americano universitarios, las principales ligas europeas de fútbol y competiciones de la UEFA, críquet, F1, UFC, tenis y golf.

    <div id="ask-for-the-league-team-and-time">
      ### Indica la liga, el equipo y el momento
    </div>
  ...
  <Tab title="Clima" icon="cloud-sun">
    ...
    Los pronósticos incluyen condiciones, temperaturas máximas y mínimas, precipitación, viento, humedad, índice UV y hora de salida y puesta del sol en la hora local del lugar.

    Una query sin fecha devuelve el pronóstico de hoy. Pide un día o un rango concreto para obtener una página por día, hasta 16 días hacia adelante o 92 días hacia atrás.
    ...
    <div id="ask-about-the-condition-that-affects-your-plan">
      ### Pregunta por la condición que afecta a tu plan
    </div>
  ...
  <Tab title="Lugares" icon="map-pin">
    ...
    * Decisiones de zonificación, permisos y registros de planificación urbana
    ...
    <div id="describe-the-place-like-you-would-ask-a-local">
      ### Describe el lugar como se lo preguntarías a un local
    </div>
...
Para obtener datos estructurados que requieren investigar en múltiples fuentes, usa una [ejecución de tarea de Exa Agent](/es/docs/agent/quickstart). Describe los lugares, equipos, fechas, criterios y campos de salida que necesitas, y Agent devolverá resultados validados contra el esquema y con citas.

<Card title="Inicia una tarea de Agent" icon="bot" href="/es/docs/agent/quickstart" cta="Abrir la guía de Agent" arrow="true">
  Compara lugares, prepara un resumen del día del partido o combina detalles locales y condiciones en resultados estructurados.
</Card>