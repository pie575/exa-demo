...
La función Importar desde CSV te permite transformar tus archivos CSV existentes con URLs en Websets totalmente funcionales. Resulta ideal cuando ya cuentas con una lista de sitios web, empresas o recursos que quieres enriquecer con datos adicionales o filtrar aplicando criteria de búsqueda.
...
* Para búsquedas de empresas: las URL deben ser URL de la página principal de la empresa (por ejemplo, [https://example.com](https://example.com))
