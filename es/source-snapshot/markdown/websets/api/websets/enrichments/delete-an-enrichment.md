...
> Al eliminar un Enrichment, se cancelarán los Enrichments en ejecución y todos los `enrichment_result` existentes generados por este Enrichment dejarán de estar disponibles.
