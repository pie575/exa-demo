...
# Cancelar un enrichment en ejecución {#cancel-a-running-enrichment}

> Se cancelarán todos los enrichments en ejecución. Un Enrichment no se puede reanudar una vez cancelado.
