...
# Cancelar un webset en ejecución {#cancel-a-running-webset}

> Cancela todas las operaciones que se estén realizando en un Webset.

Se detendrá cualquier enrichment o búsqueda y el Webset se marcará como `idle`.
