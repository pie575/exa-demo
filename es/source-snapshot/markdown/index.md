...
<div className="docs-home">
  <a className="docs-home-llms" href="/es/docs/llms.txt">
    Si eres un LLM, lee <span className="docs-home-llms-word">LLMs.txt</span>
  </a>
  ...
  <div className="docs-home-quickstart">
    ...
    <div className="docs-home-quickstart-copy">
      <span className="docs-home-quickstart-title">Añade Exa a tu agente</span>
  ...
  <div className="docs-home-try">
    ...
    <div className="docs-home-try-grid">
      <h2 className="docs-home-try-title">Ejemplos</h2>

      <div className="docs-home-langs" role="tablist" aria-label="Idioma">
      ...
      <div className="docs-home-pane">
        ...
        <div className="docs-home-code" data-pane="tools-curl">
          ...
          # 3. Devuelve los resultados al modelo para obtener la respuesta final.
