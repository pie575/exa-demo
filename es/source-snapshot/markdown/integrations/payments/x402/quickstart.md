...
<div id="make-a-paid-search-request">
  ### Realizar una solicitud de búsqueda con pago
</div>
...
<CodeGroup>
  ...
  # Paso 2: Firma el pago con tu wallet (usa el SDK para ello)
  # Paso 3: Reintenta con la firma de pago
  curl -X POST "https://api.exa.ai/search" \
    -H "Content-Type: application/json" \
    -H "PAYMENT-SIGNATURE: <base64-encoded-payment>" \
    -d '{"query": "best machine learning frameworks", "numResults": 5}'
  # Devuelve 200 con los resultados + el encabezado PAYMENT-RESPONSE (comprobante de liquidación)
  ```
</CodeGroup>
...
<div id="discovery-mode-no-wallet-needed">
  ### Modo de descubrimiento (no se necesita wallet)
</div>
