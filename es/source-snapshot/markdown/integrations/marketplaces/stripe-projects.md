...
Tu archivo `.env` ahora contiene una `EXA_API_KEY`. Los [SDKs de Exa](/es/docs/sdks/quickstart) y el [Quickstart](/es/docs/search/quickstart) leen esta variable automáticamente, por lo que tu código funciona sin cambio alguno.
