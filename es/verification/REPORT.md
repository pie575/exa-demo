...
| ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| Inventario de fuentes y navegación       | 159 de 159 páginas; sin páginas faltantes ni sobrantes                                                                                         | [Auditoría de contenido](content-audit.json)       |
| Renderizado HTTP de páginas              | 159 de 159 rutas se renderizan                                                                                                                 | [Auditoría de rutas](route-audit.json)             |
| Contenido completo de la API renderizado | 69 de 69 coinciden con producción tras normalizar los espacios en blanco                                                                       | [Comparación de la API](api-content-audit.json)    |
...
| Descargas publicadas                     | Las 9 exportaciones probadas de Markdown, LLM y esquema se resuelven con payloads coincidentes                                                 | [Auditoría de exportaciones](exports-report.json)  |
...
búsqueda local de texto completo y la navegación por teclado, los resultados vacíos, Escape, la copia al portapapeles, el cambio
de tema, el renderizado del esquema de la API, las siete pestañas de la hoja de cálculo de Agent y la
...
Las revisiones representativas finales no detectaron ninguna ventaja estética significativa en
...
de las áreas de visualización capturadas, no de una afirmación de identidad universal de píxeles ni de
equivalencia con el servicio alojado. De las 159 páginas, el texto del cuerpo coincide en 158; la
única diferencia restante es la marca de tiempo de la comprobación en la página de estado en vivo.
...
y los componentes MDX originales.
También restaura la hoja de cálculo Agent Examples omitida en la exportación a
Markdown, así como las 85 etiquetas de modificación publicadas que el renderizador
local omitió.
Las respuestas originales y las sumas de verificación se conservan en `source-snapshot/`.

El asistente de IA alojado de Exa no está disponible en la vista previa local de
Mintlify. Sus controles locales abren, en su lugar, una search de documentación
funcional. Los paneles externos y los destinos del área de pruebas de la API
siguen siendo externos. Las URL de descarga de Markdown y de esquemas usan
redirecciones a payloads `.txt` idénticos, ya que el servidor de desarrollo
nativo no sirve directamente esas extensiones de archivo. Las marcas de tiempo
de estado en vivo y los medios animados pueden variar entre capturas.
