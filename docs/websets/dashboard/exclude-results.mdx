...
description: "Avoid duplicate results in your new searches by excluding URLs from previous Websets or CSV files."
---
...
<img src="/docs/images/websets/exclude-flow.png" alt="Exclude results options when creating a Webset" width="1466" height="857" data-path="images/websets/exclude-flow.png" />
