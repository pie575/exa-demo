---
title: "Pydantic AI"
description: "Give a Pydantic AI agent web research tools backed by the Exa search API."
...
<Card title="Read Pydantic's article about building a Research Agent with Exa" icon="/docs/images/integrations/pydantic-ai/logo.svg" horizontal href="https://pydantic.dev/articles/harness-exa" width="120" height="120" data-path="images/integrations/pydantic-ai/logo.svg">
