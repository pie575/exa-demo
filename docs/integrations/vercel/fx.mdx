...
description: "Add Exa web search to fx, Vercel Labs' native coding agent, with the hosted Exa MCP server."
...
<Frame>
  <img src="/docs/images/integrations/vercel/fx/install-exa.gif" alt="Installing fx, adding the Exa MCP server with /mcp add, and running a live Exa web search" style={{width: "100%", height: "auto"}} width="800" height="393" data-path="images/integrations/vercel/fx/install-exa.gif" />
</Frame>
