...
> Extract page content with Exa Contents when you already have the URLs.

Use this skill to teach your agent to call Exa Contents with cURL or raw HTTP, using best practices.
...
<Card title="exa-contents/SKILL.md" icon="file-code" href="https://raw.githubusercontent.com/exa-labs/agent-skills/main/skills/exa-contents/SKILL.md" cta="View source" arrow="true">
