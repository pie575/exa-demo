...
<Columns cols={2}>
  <Card title="Search API guide" icon="search" href="/docs/search/quickstart" cta="Read guide" arrow="true">
    Review Exa search parameters and response fields.
  </Card>

  <Card title="LlamaIndex tool reference" icon="book" href="https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/tools/" cta="Open reference" arrow="true">
