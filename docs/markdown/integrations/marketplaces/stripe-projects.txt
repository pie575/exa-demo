...
Your `.env` now contains an `EXA_API_KEY`. The [Exa SDKs](/docs/sdks/quickstart) and [Quickstart](/docs/search/quickstart) read this variable automatically, so your code works without any changes.
...
* [Quickstart](/docs/search/quickstart): make your first Exa search with our SDKs.
