...
title: "Exa로 개발 시작하기"
sidebarTitle: "개요"
description: "agent를 위해 설계된 강력한 web search 도구입니다. 토큰 효율적이면서 정확한 결과를 얻을 수 있도록 모든 것이 최적화되어 있습니다."
mode: "wide"
timestamp: false
...
export const ApiCards = ({only}) => {
  ...
  const cards = [{
    id: "search",
    title: "Search",
    body: "토큰 효율적인 페이지 콘텐츠를 제공하는 실시간 근거 기반 데이터",
    href: "/docs/search/quickstart",
    image: "/docs/images/home/api-search.webp",
    alt: "순위가 매겨진 웹 결과와 소스 도메인이 표시된 Exa 검색창"
  }, {
    id: "agent",
    title: "Agent",
    body: "심층 리서치, 목록 작성, Enrichment를 위한 비동기 agent",
    href: "/docs/agent/quickstart",
    image: "/docs/images/home/api-agent.webp",
    alt: "파트너십, 고객 사례, 클라우드 사용량 정보가 추가된 회사 스프레드시트"
  }, {
    id: "search-deep",
    title: "Deep Search",
    body: "여러 소스를 종합해 추론하고 structured output을 반환하는 검색",
    href: "/docs/search/deep-search",
    image: "/docs/images/home/api-search-deep.webp",
    alt: "생명공학 회사에 대한 구조화된 JSON을 반환하는 심층 검색 질의"
  }, {
    id: "contents",
    title: "Contents",
    body: "모든 URL에서 전체 텍스트, highlights, summaries 제공",
    href: "/docs/contents/quickstart",
    image: "/docs/images/home/api-contents.webp",
    alt: "Boeing의 Wikipedia 페이지 콘텐츠 추출 결과"
  }, {
    id: "monitors",
    title: "Monitors",
    body: "웹을 모니터링하고 새 결과를 푸시하는 예약 검색",
    href: "/docs/monitors/quickstart",
    image: "/docs/images/home/api-monitors.webp",
    alt: "매일 실행되는 Anthropic Releases and News라는 이름의 모니터",
    hidden: true
  }];
...
<div className="docs-home">
    ...
    <div className="docs-home-try-grid">
      ...
      <div className="docs-home-pane">
        ...
        <div className="docs-home-code" data-pane="tools-curl">
          ```bash theme={null}
          # 1. 모델에 Exa search 도구를 제공하고 질의는 모델이 직접 정하도록 합니다.
          ...
          # 3. 최종 답변을 받기 위해 결과를 모델에 다시 넘깁니다.
  ...
  <h2 className="docs-home-section">제공 API</h2>
