...
title: "Exa로 개발 시작하기"
sidebarTitle: "개요"
description: "agent를 위해 설계된 강력한 web search 도구입니다. 토큰 효율적이고 정확한 결과를 얻을 수 있도록 모든 것이 최적화되어 있습니다."
mode: "wide"
timestamp: false
...
export const ApiCards = ({only}) => {
  ...
  const cards = [{
    ...
    alt: "순위가 매겨진 웹 결과와 소스 도메인을 보여주는 Exa search 상자"
  }, {
    id: "agent",
    title: "Agent",
    ...
    alt: "파트너십, 고객 사례, 클라우드 사용량 정보로 enrichment된 회사 스프레드시트"
  }, {
    id: "search-deep",
    title: "Deep Search",
    body: "여러 소스를 기반으로 추론하고 structured output을 반환하는 Search",
    ...
    alt: "Boeing 관련 Wikipedia 페이지에서 추출한 페이지 콘텐츠"
  }, {
    id: "monitors",
    title: "Monitors",
    body: "웹을 모니터링하고 새 결과를 푸시하는 예약된 검색",
...
<div className="docs-home">
  ...
  <div className="docs-home-try">
    ...
    <div className="docs-home-try-grid">
      <h2 className="docs-home-try-title">예시</h2>
      ...
      <div className="docs-home-pane">
        ...
        <div className="docs-home-code" data-pane="tools-curl">
          ```bash theme={null}
          # 1. 모델에 Exa search 도구를 제공하고 질의는 모델이 직접 정하게 합니다.
          ...
          # 3. 최종 답변을 얻기 위해 결과를 모델에 다시 넘깁니다.
