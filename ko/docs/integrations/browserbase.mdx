---
title: "Browserbase"
description: "Exa 기업 검색과 Browserbase 브라우저 자동화를 결합해 채용 지원 워크플로우를 구축하세요."
...
Exa와 Browserbase에서 사용할 API key를 설정합니다:
...
다음 예제는 템플릿의 워크플로우를 그대로 따릅니다. 기업을 search하고, careers page를 찾아 Browserbase 세션에서 열고, 채용 공고 내용을 추출한 뒤, Stagehand agent가 해당 페이지와 상호작용하도록 합니다.
