...
sidebarTitle: "개요"
icon: "database"
description: "Exa가 공개 웹과 비공개 데이터 소스 전반에서 인덱싱하는 항목."
---
...
export const PlaygroundQuery = ({query, category, filters}) => {
  ...
  return <div className="playground-query not-prose">
      ...
      <a className="playground-query-run" href={href} target="_blank" rel="noreferrer" title="API 플레이그라운드에서 열기" aria-label={`"${query}"를 API 플레이그라운드에서 열기`}>
        {}
...
<AccordionGroup>
  <Accordion title="뉴스" icon="newspaper">
    <Card title="뉴스 가이드" icon="newspaper" href="/ko/docs/search/data/news" cta="가이드 읽기" arrow="true">
      뉴스 search 활용 사례와 예시, 모범 사례를 살펴보세요.
    </Card>
  ...
  <Accordion title="코드 및 문서" icon="code">
    <Card title="코드 & 문서 가이드" icon="code" href="/ko/docs/search/data/code" cta="가이드 읽기" arrow="true">
      코드 search 활용 사례, 예시, 모범 사례를 살펴보세요.
    </Card>
  ...
  <Accordion title="연구 출판물" icon="book-open">
    <Card title="리서치 출판물 가이드" icon="book-open" href="/ko/docs/search/data/research" cta="가이드 읽기" arrow="true">
      논문, 특허, 임상, 규제 관련 리서치 활용 사례를 살펴보세요.
    </Card>
  ...
  <Accordion title="스포츠, 날씨 및 장소" icon="map-pin">
    <Card title="스포츠, 날씨 및 장소 가이드" icon="map-pin" href="/ko/docs/search/data/sports-weather-places" cta="가이드 읽기" arrow="true">
      실시간 스포츠 데이터, 날씨 예보, 지역 정보를 질의하는 방법을 알아보세요.
    </Card>
  ...
  <Accordion title="사이버 보안" icon="shield">
    <Card title="사이버 보안 가이드" icon="shield" href="/ko/docs/search/data/security" cta="가이드 읽기" arrow="true">
      취약점, 보안 권고문, 벤더 리스크 활용 사례를 살펴보세요.
    </Card>
...
이 가이드는 일반적인 데이터 패턴을 다루지만, Exa는 다양한 사이트와 형식, 언어에 걸쳐 더 넓은 공개 웹까지 검색합니다.