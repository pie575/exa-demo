...
<Update label="August 28, 2026" rss={{ title: "Dynamic Highlights (research preview)" }}>
  ## Dynamic Highlights (研究预览版) {#dynamic-highlights-research-preview}
...
<Update label="July 29, 2025" rss={{ title: "新的 Fast 搜索类型" }}>
  ## 新的 Fast 搜索类型 {#new-fast-search-type}
...
<Update label="July 21, 2025" rss={{ title: "Auto Search 中的 Score 弃用" }}>
  ## Auto Search 中的 Score 弃用 {#score-deprecation-in-auto-search}
...
<Update label="June 23, 2025" rss={{ title: "Markdown 页面内容成为默认值" }}>
  ## Markdown 页面内容成为默认值 {#markdown-contents-as-default}
...
<Update label="May 22, 2025" rss={{ title: "页面内容 端点状态变更" }}>
  ## 页面内容 端点状态变更 {#contents-endpoint-status-changes}
...
<Update label="December 11, 2024" rss={{ title: "Auto search 成为默认值" }}>
  ## Auto search 成为默认值 {#auto-search-as-default}
