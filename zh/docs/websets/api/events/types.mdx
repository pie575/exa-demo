...
title: "事件类型"
sidebarTitle: "类型"
description: "了解 Webset API 中会发生哪些事件"
timestamp: false
searchable: false
---

Websets API 通过事件通知你 Websets 中发生的变更。你可以使用我们的 [events 端点](/zh/docs/websets/api/events/list-all-events) 或配置 [webhook](/zh/docs/websets/api/webhooks/create-a-webhook) 来监控这些事件。
