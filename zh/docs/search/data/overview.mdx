...
sidebarTitle: "概览"
icon: "database"
description: "Exa 在公开网络和私有数据源中索引哪些内容。"
---
...
Exa 搜索公开网络以及精选的私有数据源，覆盖范围持续更新。具体包括：
...
这些指南涵盖了常见的数据模式，但 Exa 的搜索范围更广，可跨越众多站点、格式和语言检索更广泛的公开网络。