...
sidebarTitle: "概览"
icon: "database"
description: "Exa 对公开网络和私有数据源索引了哪些内容。"
---
...
<AccordionGroup>
  ...
  <Accordion title="金融市场" icon="chart-line">
    <Card title="金融市场指南" icon="chart-line" href="/zh/docs/search/data/financial" cta="阅读指南" arrow="true">
      探索行情报价、监管申报文件、财报电话会议和市场研究等应用场景。
    </Card>
  ...
  <Accordion title="体育、天气与地点" icon="map-pin">
...
这些指南涵盖常见的数据模式，但 Exa 的搜索范围还延伸到更广泛的公开网络，覆盖众多站点、格式和语言。