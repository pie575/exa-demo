...
# 体育、天气与地点 {#sports-weather-places}
...
### 指明地点和日期 {#name-the-place-and-day}

    <PlaygroundQuery query="weather in San Francisco tomorrow" />

### 询问影响你行程安排的天气状况 {#ask-about-the-condition-that-affects-your-plan}

    <PlaygroundQuery query="will it rain in Austin this weekend" />

### 将预报与报道结合 {#combine-forecasts-with-reporting}
...
### 像向当地人打听一样描述地点 {#describe-the-place-like-you-would-ask-a-local}

    把类别、街区和你关心的属性组合起来。

    <PlaygroundQuery query="late-night ramen in the Sunset District with outdoor seating" />

### 指明记录类型和地理范围 {#name-the-record-type-and-geography}

    <PlaygroundQuery query="multifamily zoning variances approved in Denver" />

### 按实际约束条件比较地点 {#compare-places-against-practical-constraints}
