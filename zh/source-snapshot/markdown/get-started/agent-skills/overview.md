...
Exa skill 可以教会编码智能体如何使用 Exa 的 API 进行搜索、获取内容并构建应用。你可以在开源代码仓库 [exa-labs/agent-skills](https://github.com/exa-labs/agent-skills) 中找到它们。
