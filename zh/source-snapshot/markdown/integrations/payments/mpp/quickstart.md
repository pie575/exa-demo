...
# 使用 MPP (Tempo) 支付 {#pay-with-mpp-tempo}
...
### 发起付费 search 请求 {#make-a-paid-search-request}
...
### 查看余额和积分 {#check-balances-and-credits}
...
## 支付流程的工作原理 {#how-the-payment-flow-works}
...
### 查看支付质询 {#inspect-a-payment-challenge}
