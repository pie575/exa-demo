...
[Polymarket](https://polymarket.com) 是一个预测市场平台，其市场价格反映了群体对现实世界结果的隐含概率。[Exa Connect](/zh/docs/agent/connect/overview) 提供对 Polymarket 公开市场数据的只读访问。
...
| 数据      | 说明                            |
| ------- | ----------------------------- |
| 市场与事件   | 当前的预测市场和事件，包含隐含概率价格、交易量和流动性。  |
...
<Columns cols={2}>
  ...
  <Card title="组合多个提供方" icon="blend" href="/zh/docs/agent/connect/combining-providers" cta="阅读指南" arrow="true">
    单次运行最多可附加五个合作伙伴，并通过设计 query 让每一个都被触发。
  </Card>
