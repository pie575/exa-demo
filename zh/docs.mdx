...
title: "开始使用 Exa 构建"
sidebarTitle: "概览"
description: "专为 agent 打造的强大网页搜索工具。全面优化，为你提供节省 token 且精准的结果。"
mode: "wide"
timestamp: false
...
export const ApiCards = ({only}) => {
  ...
  const cards = [{
    ...
    alt: "包含合作关系、客户案例和云用量等增强信息的公司电子表格"
  }, {
    id: "search-deep",
    title: "深度搜索",
    ...
    alt: "返回有关生物技术公司的结构化 JSON 的深度搜索 query"
  }, {
    id: "contents",
    title: "Contents",
  ...
  <div className="docs-home-try">
    ...
    <div className="docs-home-try-grid">
      ...
      <div className="docs-home-apis" role="tablist" aria-label="API">
        ...
        <label htmlFor="docs-home-api-agent">构建经过调研的列表</label>
