...
title: "开始使用 Exa 构建"
sidebarTitle: "概览"
description: "专为智能体打造的强大网页搜索工具。全面优化，助你获得节省 token 且精准的结果。"
mode: "wide"
timestamp: false
...
export const ApiCards = ({only}) => {
  ...
  const cards = [{
    id: "search",
    title: "Search",
    body: "提供实时、可靠的数据和高 token 效率的页面内容",
    ...
    id: "agent",
    title: "Agent",
    body: "用于深度研究、列表构建和 enrichment 的异步 Agent",
    href: "/docs/agent/quickstart",
    image: "/docs/images/home/api-agent.webp",
    alt: "包含合作伙伴、客户案例和云服务使用情况等补充信息的公司电子表格"
  }, {
    id: "search-deep",
    title: "Deep Search",
    ...
    alt: "返回有关生物技术公司的结构化 JSON 的 Deep Search query"
  }, {
    id: "contents",
    title: "Contents",
  ...
  <div className="docs-home-try">
    ...
    <div className="docs-home-try-grid">
      ...
      <div className="docs-home-apis" role="tablist" aria-label="API">
        ...
        <label htmlFor="docs-home-api-agent">生成经过调研的列表</label>
