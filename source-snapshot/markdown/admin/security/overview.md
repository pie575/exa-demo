...
> Exa security, compliance, and regional access information.
...
Contact us at [sales@exa.ai](mailto:sales@exa.ai) to discuss an Enterprise plan if you are interested in [Zero Data Retention](/docs/admin/security/zero-data-retention), [HIPAA compliance](/docs/admin/security/hipaa), or other customized data security solutions.
