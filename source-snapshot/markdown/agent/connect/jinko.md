...
Attach `jinko` to an [Exa Agent](/docs/agent/quickstart) run through
[Exa Connect](/docs/agent/connect/overview), and the agent queries
Jinko alongside Exa web search.
...
* [Similarweb](/docs/agent/connect/similarweb): research the travel sites and booking platforms behind a destination.
* [Particle](/docs/agent/connect/particle): pull recent coverage and travel commentary for a place.
