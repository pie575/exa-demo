...
[Exa MCP](/docs/get-started/exa-mcp) gives Codex and ChatGPT tools for accessing Exa. It's the connection between the agent and Exa's search and research capabilities.

[Exa skills](/docs/get-started/agent-skills/overview) give the agent additional instructions for using those capabilities in useful workflows, including web research and [Exa Agent](/docs/agent/quickstart).
...
<Card title="Install Exa for ChatGPT and Codex" icon="download" horizontal href="https://chatgpt.com/plugins/exa?open_in_app">
  Add the Exa plugin from the ChatGPT marketplace.
</Card>
