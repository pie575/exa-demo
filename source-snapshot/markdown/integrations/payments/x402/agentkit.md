...
* Once free trial uses are exhausted for the month, the agent falls back to the standard [x402 payment flow](/docs/integrations/payments/x402/quickstart)
* The same [10-result cap](/docs/integrations/payments/x402/quickstart#pricing) applies to free trial requests on `/search`
...
* [x402 payment guide](/docs/integrations/payments/x402/quickstart): standard USDC payment flow
