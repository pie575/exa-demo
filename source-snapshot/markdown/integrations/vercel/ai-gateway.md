...
<Columns cols={2}>
  <Card title="Use the Exa AI SDK" icon="code" href="/docs/integrations/vercel/ai-sdk" cta="Open guide" arrow="true">
    Call Exa directly with an Exa API key through `@exalabs/ai-sdk`.
  </Card>

  <Card title="Read Vercel's web search reference" icon="book" href="https://vercel.com/docs/ai-gateway/models-and-providers/web-search" cta="Open reference" arrow="true">
