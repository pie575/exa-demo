...
<Columns cols={2}>
  <Card title="Use Vercel AI Gateway" icon="cloud" href="/docs/integrations/vercel/ai-gateway" cta="Open guide" arrow="true">
    Use Exa web search without an Exa API key through Vercel's AI Gateway.
  </Card>

  <Card title="Explore the AI SDK package" icon="git-branch" href="https://github.com/exa-labs/ai-sdk" cta="View source" arrow="true">
