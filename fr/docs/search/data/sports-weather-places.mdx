---
title: "Sports, météo et lieux"
sidebarTitle: "Sports, météo et lieux"
icon: "map-pin"
...
Utilisez Exa Search pour obtenir des données sportives en direct, des prévisions météo et des informations locales, sans avoir à intégrer une API distincte pour chacune d&#39;elles. Posez une question en langage naturel en précisant l&#39;équipe, le lieu et la période qui vous intéressent.
...
<Tabs>
  ...
  <Tab title="Météo" icon="cloud-sun">
    ...
    Les prévisions couvrent les conditions, les températures maximales et minimales, les précipitations, le vent, l&#39;humidité, l&#39;indice UV ainsi que le lever et le coucher du soleil à l&#39;heure locale du lieu.

    Une query sans date renvoie les prévisions du jour. Demandez un jour ou une plage précise pour obtenir une page par jour, jusqu&#39;à 16 jours à l&#39;avance ou 92 jours en arrière.
  ...
  <Tab title="Lieux" icon="map-pin">
    ...
    * Fiches de commerces locaux, avec adresses, horaires, équipements et avis
...
<Card title="Lancer une tâche Exa Agent" icon="bot" href="/fr/docs/agent/quickstart" cta="Ouvrir le guide Agent" arrow="true">
  Comparez des lieux, préparez un dossier de jour de match ou regroupez détails locaux et conditions dans des résultats structurés.
</Card>