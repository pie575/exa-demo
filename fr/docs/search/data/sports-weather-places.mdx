---
title: "Sport, météo et lieux"
sidebarTitle: "Sport, météo et lieux"
icon: "map-pin"
description: "Trouvez des données sportives en direct, des prévisions météo et des lieux à proximité avec Exa Search."
---
...
### Inclus {#included}
    ...
    * **Classements** : tableaux de classement actuels, avec répartition par conférence ou division
    * **Calendriers** : résultats passés et matchs à venir d&#39;une ligue ou d&#39;une équipe
...
### Ajoutez le contexte autour de l&#39;événement {#add-the-surrounding-story}
...
### Interrogez la condition qui influence vos plans {#ask-about-the-condition-that-affects-your-plan}

    <PlaygroundQuery query="will it rain in Austin this weekend" />

### Combinez prévisions et articles d&#39;actualité {#combine-forecasts-with-reporting}
...
### Précisez le type de record et la zone géographique {#name-the-record-type-and-geography}

    <PlaygroundQuery query="multifamily zoning variances approved in Denver" />

### Comparez les lieux selon des contraintes concrètes {#compare-places-against-practical-constraints}
...
Pour des données structurées nécessitant une recherche sur plusieurs sources, utilisez un [run de tâche Exa Agent](/fr/docs/agent/quickstart). Décrivez les lieux, équipes, dates, critères et fields d&#39;output dont vous avez besoin, et Agent renvoie des résultats validés par schéma, accompagnés de citations.

<Card title="Lancer une tâche Exa Agent" icon="bot" href="/fr/docs/agent/quickstart" cta="Ouvrir le guide Agent" arrow="true">
  Comparez des lieux, constituez un dossier de match ou regroupez détails locaux et conditions dans des résultats structurés.
</Card>