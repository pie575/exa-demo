...
* `maxAgeHours` : le repli sur le cache par défaut ; définissez cette option si vous avez besoin d&#39;une fraîcheur plus stricte
...
| `contents.maxAgeHours`                                 | N&#39;utilise le contenu en cache que s&#39;il respecte l&#39;ancienneté indiquée ; sinon, recourt au livecrawl. |
...
Le package est également disponible sur [npm](https://www.npmjs.com/package/@exalabs/ai-sdk), et vous pouvez consulter le [guide de recherche web du Vercel AI SDK](https://ai-sdk.dev/cookbook/node/web-search-agent#exa).