...
Exa est disponible sous forme de plugin sur la marketplace [Grok Build](https://docs.x.ai/build/overview). Le plugin apporte à Grok la recherche web en temps réel, la lecture de pages et une compétence de recherche approfondie.
...
* « Recherche des actualités récentes sur xAI »
