---
title: "LlamaIndex"
description: "Un guide de démarrage rapide pour ajouter le retrieval Exa à une application LlamaIndex Agent."
...
LlamaIndex est un framework permettant de créer des applications LLM s&#39;appuyant sur des données structurées. Dans ce guide, nous allons utiliser l&#39;intégration LlamaIndex d&#39;Exa pour :

1. Déclarer le Search and Retrieve Highlight Tool d&#39;Exa comme retriever LlamaIndex
2. Mettre en place un OpenAI Agent qui utilise ce tool pour générer ses réponses
...
<Steps>
  <Step title="Prérequis et installation">
    ...
    Vérifiez également que les API keys sont correctement initialisées. Le code suivant utilise `EXA_API_KEY` comme nom d&#39;environment variable.
  ...
  <Step title="Choisir la méthode Exa à utiliser">
    Dans cet exemple, seule la méthode [search&#95;and&#95;retrieve&#95;highlights](https://docs.llamaindex.ai/en/stable/api_reference/tools/exa/) nous intéresse : nous la transmettons à notre agent via la méthode LlamaIndex `.to_tool_list`. Nous transmettons aussi `current_date`, un utilitaire simple qui permet à notre agent de connaître la date du jour.
  ...
  <Step title="Configurer un OpenAI Agent et effectuer des requêtes Exa-powered">
    ...
    Il suffit ensuite d&#39;utiliser la méthode chat pour interagir avec l&#39;agent.
    ...
    L&#39;agent call les tools Exa qui lui ont été fournis, puis formule sa réponse à partir des résultats. L&#39;output exact varie selon la query et les dates de publication des pages renvoyées par Exa.
  </Step>
</Steps>

<Columns cols={2}>
  <Card title="Guide de la Search API" icon="search" href="/fr/docs/search/quickstart" cta="Lire le guide" arrow="true">
    Passez en revue les search parameters et les fields de response d&#39;Exa.
  </Card>

  <Card title="Reference des tools LlamaIndex" icon="book" href="https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/tools/" cta="Ouvrir la reference" arrow="true">
