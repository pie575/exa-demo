---
title: "Browserbase"
description: "Associez la recherche d'entreprises Exa à l'automatisation de navigateur Browserbase pour vos workflows de candidature."
...
L&#39;exemple suivant reprend le workflow du template : rechercher des entreprises, repérer une careers page, l&#39;ouvrir dans une session Browserbase, extraire la description du poste et laisser un agent Stagehand interagir avec la page.
