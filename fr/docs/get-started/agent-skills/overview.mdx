...
description: "Installez les skills Exa dans Claude Code, Codex et d'autres coding agents."
...
Vous pouvez aussi ouvrir l&#39;une des pages de skill ci-dessous et copier son setup prompt dans votre agent. Le prompt installe la skill et vérifie votre clé API sans l&#39;afficher.
...
<Columns cols={3}>
  <Card title="Développer avec Exa" icon="rocket" href="/fr/docs/get-started/agent-skills/build-with-exa" cta="Ouvrir le skill" arrow="true">
    Créez des applications et des agents avec la plateforme d&#39;API complète d&#39;Exa.
  </Card>
