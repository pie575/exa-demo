...
[Fiber.ai](https://fiber.ai) est une plateforme de données B2B qui fournit des données à jour sur plus de 40 M d&#39;entreprises, 850 M de personnes et 30 M d&#39;offres d&#39;emploi. Interrogez en temps réel des données sur les entreprises, les personnes et les emplois, et enrichissez les records incomplets avec des e-mails professionnels, des e-mails personnels et des numéros de téléphone.

Attachez `fiber` à un run [Exa Agent](/fr/docs/agent/quickstart) via [Exa Connect](/fr/docs/agent/connect/overview) : l&#39;agent interroge alors Fiber.ai en parallèle d&#39;Exa web search.

## Cas d&#39;usage {#use-it-for}

* Nettoyer un CRM en identifiant une personne à partir d&#39;un e-mail professionnel
  ou personnel (recherche inversée), ou en enrichissant un record partiel
...
* Trouver des publications pertinentes sur LinkedIn, X, Instagram, TikTok, Reddit
  et YouTube, récupérer leurs commentaires et réactions, puis enrichir les
...
Fiber.ai facture en crédits au tarif de `$0.02 / credit`, et chaque appel est facturé selon
les crédits que Fiber déclare pour celui-ci :
...
Les appels qui ne renvoient aucune correspondance (ou dont Fiber rembourse le montant) sont gratuits. Le choix des
...
Constituez une liste de prospection B2B de sociétés fintech en série A basées à New York et comptant de 50 à 200 employés.
...
* [Particle](/fr/docs/agent/connect/particle) : découvrir ce que les podcasts disent d&#39;une entreprise ou d&#39;un dirigeant.
