---
title: "Baselayer"
description: "Vérifiez les entreprises américaines et récupérez des données KYB : officers, registrations, scores de risque."
icon: "/docs/images/sidebar-icons/baselayer.svg"
---

[Baselayer](https://baselayer.com) est une plateforme de Know Your Business (KYB) qui
vérifie les entités américaines à partir de données d&#39;registration et de risque faisant autorité. Elle
identifie une entreprise par son nom et son adresse et renvoie son profil complet : officers,
registrations par État, structure juridique et statut de vérification.
...
* Onboarding KYB et verification des vendors et des clients.
* Diligence raisonnable sur les officers, les registrations et la structure de l&#39;entité.
...
| Consultation d&#39;entreprise / officers / registrations / recherche inversée d&#39;officer | Gratuit (lecture d&#39;une recherche antérieure) |
...
états coûte 4,00 $, un filtrage sur l&#39;ensemble des six watchlists prises en charge
coûte 1,35 $, et un appel de présence en ligne correspond à la somme des analyses
sélectionnées (ou de l&#39;ensemble par défaut de Baselayer — prédiction NAICS et
analyse de site web — si vous n&#39;en sélectionnez aucune).
