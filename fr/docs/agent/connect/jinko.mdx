---
title: "Jinko"
description: "Recherche de vols et d'hôtels avec tarification en temps réel."
icon: "/docs/images/sidebar-icons/jinko.svg"
---

[Jinko](https://gojinko.com) est une plateforme de recherche de voyages proposant la recherche de vols et
d&#39;hôtels avec une tarification en temps réel. Recherchez des offres de vol en temps réel pour un itinéraire et
...
* Trouver des hôtels avec des tarifs de chambre en temps réel pour une destination, ou réinterroger des hôtels précis.
* Découvrir des destinations et des dates flexibles sur différentes plages de dates, classes de cabine et budgets.
...
<Columns cols={2}>
  ...
  <Card title="Combiner des providers" icon="blend" href="/fr/docs/agent/connect/combining-providers" cta="Lire le guide" arrow="true">
    Attachez jusqu&#39;à cinq partners à un même run et formulez la requête de façon à ce que chacun soit déclenché.
  </Card>
