---
title: "Jinko"
description: "Recherche de vols et d'hôtels avec tarifs en temps réel."
icon: "/docs/images/sidebar-icons/jinko.svg"
---

[Jinko](https://gojinko.com) est une plateforme de recherche de voyages qui propose
la recherche de vols et d&#39;hôtels avec des tarifs en temps réel. Recherchez les offres de vols disponibles pour un itinéraire et
une date donnés, comparez les chambres et les tarifs d&#39;hôtel pour une destination ou des établissements précis, et
...
* Rechercher des offres de vols en temps réel avec les tarifs, les conditions bagages et les conditions de modification pour un itinéraire et une date.
* Trouver des hôtels avec les tarifs des chambres en temps réel pour une destination, ou réinterroger des hôtels précis.
...
Trouver des destinations balnéaires accessibles depuis New York pour moins de $400 l&#39;aller-retour en mars.
...
* [Similarweb](/fr/docs/agent/connect/similarweb) : étudiez les sites de voyage et les plateformes de réservation liés à une destination.
* [Particle](/fr/docs/agent/connect/particle) : récupérez la couverture médiatique récente et les commentaires de voyageurs sur un lieu.
