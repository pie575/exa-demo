---
title: "Similarweb"
description: "Obtenez des estimations de trafic de sites web, des classements mondiaux et la découverte de concurrents."
icon: "/docs/images/sidebar-icons/similarweb.svg"
---

[Similarweb](https://www.similarweb.com) est une source de référence en matière
d&#39;intelligence des marchés numériques. La plateforme modélise le trafic et l&#39;engagement de
millions de sites web et d&#39;applications : visites estimées, sources de
trafic, données démographiques de l&#39;audience et paysage concurrentiel autour de
n&#39;importe quel domaine.

Attachez `similarweb` à un run d&#39;[Exa Agent](/fr/docs/agent/quickstart) via
...
* Enrichir vos analyses d&#39;entreprises et de secteurs avec des données comportementales réelles.
...
Similarweb facture en crédits de données à `0,30 $ / crédit`, et chaque appel est facturé
selon les crédits que Similarweb déclare pour celui-ci. Les crédits varient en fonction des données renvoyées —
environ un crédit par point de données (métrique × ligne × mois) — si bien que le prix d&#39;un appel
...
volume de recherche) sont gratuits. `numResults` et `months` déterminent le nombre de points de données
que vous payez : limitez-les au strict nécessaire pour votre tâche.

<div id="example">
  ## Exemple
</div>

Trouvez 10 entreprises SaaS B2B à forte croissance et leur trafic web estimé.
...
<Columns cols={2}>
  ...
  <Card title="Découvrir Exa Agent" icon="book-open" href="/fr/docs/agent/quickstart" cta="Ouvrir le guide" arrow="true">
    Créez des runs, suivez la progression en temps réel, concevez des schemas de sortie et maîtrisez l&#39;effort et le coût.
  </Card>
