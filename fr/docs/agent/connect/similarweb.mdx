---
title: "Similarweb"
description: "Obtenez des estimations de trafic des sites web, des classements mondiaux et identifiez les concurrents."
...
millions de sites web et d&#39;applications : visites estimées, sources de trafic,
données démographiques d&#39;audience et paysage concurrentiel de n&#39;importe quel domaine.
...
* Comparer le trafic web et l&#39;engagement d&#39;une entreprise à ceux de ses pairs.
...
environ un crédit par point de données (métrique × ligne × mois) — de sorte que le prix d&#39;un appel
...
| Chevauchement d&#39;audience             | 2 par combinaison de domaines (2 à 3 domaines : 6 à 14)                       |
| Technologies                             | 10                                                                            |
...
sont facturés : gardez-les aussi bas que la tâche le permet.
...
* [Fiber.ai](/fr/docs/agent/connect/fiber) : transformez les concurrents découverts en records d&#39;entreprise enrichis.
