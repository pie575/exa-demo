...
> Récupérez les données d&#39;usage et de facturation d&#39;une API key spécifique.
...
L&#39;endpoint Get API Key Usage vous permet de récupérer des statistiques détaillées de facturation et d&#39;usage pour une API key donnée sur une période déterminée. Cet endpoint renvoie les données de coût issues du système de facturation d&#39;Exa, offrant ainsi une vue de référence sur ce qui vous est facturé pour cette API key.

<div id="path-parameters">
  ## Paramètres de chemin
</div>

* **id** : L&#39;identifiant unique de l&#39;API key dont vous souhaitez récupérer l&#39;usage

<div id="query-parameters">
  ## Paramètres de requête
</div>

* **start&#95;date** (facultatif) : date de début de la période d&#39;usage au format ISO 8601 (par exemple, `2025-01-01T00:00:00Z` ou `2025-01-01`). Par défaut : il y a 30 jours. Doit se situer dans les 6 derniers mois (180 jours).
* **end&#95;date** (facultatif) : date de fin de la période d&#39;usage au format ISO 8601. Par défaut : l&#39;heure actuelle.
* **group&#95;by** (facultatif) : granularité temporelle utilisée pour regrouper les résultats (`hour`, `day` ou `month`). Actuellement réservé à de futures évolutions, ce paramètre ne modifie pas la structure de la response. Valeur par défaut : `day`.

<div id="response">
  ## Réponse
</div>

Renvoie des informations détaillées d&#39;usage et de facturation, notamment :
...
* **team&#95;id** : identifiant de la Team à laquelle cette key appartient
* **period** : objet contenant les dates de début et de fin de la période d&#39;usage
* **total&#95;cost&#95;usd** : coût total en USD pour la période indiquée
...
* **metadata** : objet contenant le timestamp de génération du rapport

<div id="important-notes">
  ## Remarques importantes
</div>

* **Limite d&#39;historique de 6 mois** : le système de facturation applique une limite d&#39;historique de 6 mois (180 jours). Les requests dont la `start_date` remonte à plus de 180 jours renvoient une erreur 400.
* **Usage nul** : si l&#39;API key n&#39;enregistre aucun usage sur la période demandée, `total_cost_usd` vaudra 0 et `cost_breakdown` pourra être vide.
* **Appartenance à la team** : l&#39;API key de service utilisée pour l&#39;authentification doit appartenir à la même team que l&#39;API key demandée. L&#39;accès inter-teams n&#39;est pas autorisé.
...
* Surveiller l&#39;usage et les coûts d&#39;API keys spécifiques
* Mettre en place des alertes automatisées basées sur des seuils d&#39;usage
* Générer des rapports d&#39;usage pour la répartition interne des coûts
