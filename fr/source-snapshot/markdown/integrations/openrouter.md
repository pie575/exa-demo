...
Avec la valeur par défaut `engine: "auto"`, OpenRouter utilise la recherche native du fournisseur lorsque le modèle en propose une, et Exa dans tous les autres cas. Définissez `engine: "exa"` pour conserver un comportement de recherche identique sur tous les modèles :
