...
| Option                                                 | Description                                                                       |
| ------------------------------------------------------ | --------------------------------------------------------------------------------- |
| `type`                                                 | Mode de recherche : `auto` (par défaut), `fast` ou `instant`.                     |
...
| `userLocation`                                         | Code pays ISO à deux lettres pour une recherche tenant compte de la localisation. |
...
| `contents.subpages` / `contents.subpageTarget`         | Explorer les sous-pages et, éventuellement, en cibler une.                        |
...
Après cette date, Vercel facture les requests via AI Gateway aux tarifs indiqués dans la [documentation recherche web de Vercel](https://vercel.com/docs/ai-gateway/models-and-providers/web-search).

<Note>
  Cette integration prend actuellement en charge les modes de recherche standard d&#39;Exa et les contrôles d&#39;extraction de contenu. Les modes de synthèse deep et les résumés générés ne sont pas encore disponibles.
</Note>

<Columns cols={2}>
  <Card title="Utiliser l'AI SDK Exa" icon="code" href="/fr/docs/integrations/vercel/ai-sdk" cta="Ouvrir le guide" arrow="true">
    Appelez Exa directement avec une API key Exa via `@exalabs/ai-sdk`.
  </Card>

  <Card title="Consulter la référence recherche web de Vercel" icon="book" href="https://vercel.com/docs/ai-gateway/models-and-providers/web-search" cta="Ouvrir la référence" arrow="true">
