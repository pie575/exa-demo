...
> Trouvez des pages web pertinentes et obtenez du contenu synthétisé en moins de deux secondes avec Exa Search.

Utilisez cette skill pour apprendre à votre agent à appeler Exa Search en cURL ou en raw HTTP, selon les bonnes pratiques.
...
**Option A : installer directement cette skill :**
...
<Card title="exa-search/SKILL.md" icon="file-code" href="https://raw.githubusercontent.com/exa-labs/agent-skills/main/skills/exa-search/SKILL.md" cta="Voir la source" arrow="true">
  Lisez la définition de la skill exa-search avant de l&#39;installer.
</Card>
