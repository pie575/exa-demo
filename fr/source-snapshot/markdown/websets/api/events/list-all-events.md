        ...
        recall:
          properties:
            expected:
              ...
              type: object
            reasoning:
              description: Le raisonnement à l'origine de l'estimation
              type: string
          required:
            - expected
            - reasoning
      ...
      properties:
        ...
        format:
          enum:
            - csv
            - webset
          description: Le format de l'import.
          type: string
        entity:
          $ref: '#/components/schemas/Entity'
        ...
        failedReason:
          enum:
            ...
            - missing_identifier
          type: string
          description: La raison de l'échec de l'import
          nullable: true
        failedAt:
          format: date-time
          type: string
          description: Le moment où l'import a échoué
          nullable: true
        failedMessage:
          type: string
          description: Un message lisible décrivant l'échec de l'import
          nullable: true
        createdAt:
          format: date-time
          description: Le moment où l'import a été créé
          type: string
        updatedAt:
          format: date-time
          description: Le moment de la dernière mise à jour de l'import
          type: string
      required:
        - id
        - object
    ...
    Monitor:
      properties:
        ...
        cadence:
          ...
          required:
            - cron
          description: La fréquence d'exécution du monitor
          type: object
        behavior:
          properties:
            config:
