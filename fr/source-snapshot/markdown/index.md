...
<div className="docs-home">
  <a className="docs-home-llms" href="/fr/docs/llms.txt">
    Si vous êtes un LLM, lisez <span className="docs-home-llms-word">LLMs.txt</span>
  </a>
  ...
  <div className="docs-home-try">
    ...
    <div className="docs-home-try-grid">
      <h2 className="docs-home-try-title">Exemples</h2>

      <div className="docs-home-langs" role="tablist" aria-label="Langue">
