---
title: "Commencez à développer avec Exa"
sidebarTitle: "Vue d'ensemble"
description: "Un puissant outil de recherche web conçu pour les agents. Tout est optimisé pour vous fournir des résultats précis et économes en tokens."
mode: "wide"
timestamp: false
...
export const ApiCards = ({only}) => {
  ...
  const cards = [{
    id: "search",
    title: "Search",
    body: "Données en temps réel étayées par des sources, avec un contenu de page économe en jetons",
    href: "/fr/docs/search/quickstart",
    ...
    href: "/fr/docs/agent/quickstart",
    image: "/docs/images/home/api-agent.webp",
    alt: "Feuille de calcul d’entreprises enrichie de partenariats, de témoignages clients et de données d’utilisation du cloud"
  }, {
    id: "search-deep",
    title: "Deep Search",
    body: "Search qui raisonne à partir de plusieurs sources et renvoie une sortie structurée",
    href: "/fr/docs/search/deep-search",
    ...
    href: "/fr/docs/contents/quickstart",
    ...
    href: "/fr/docs/monitors/quickstart",
...
<div className="docs-home">
  <a className="docs-home-llms" href="/fr/docs/llms.txt">
    Si vous êtes un LLM, consultez <span className="docs-home-llms-word">LLMs.txt</span>
  </a>
  ...
  <div className="docs-home-try">
    ...
    <div className="docs-home-try-grid">
      ...
      <div className="docs-home-apis" role="tablist" aria-label="API">
        ...
        <label htmlFor="docs-home-api-agent">Constituer une liste documentée</label>
      ...
      <div className="docs-home-pane">
        ...
        <div className="docs-home-code" data-pane="tools-curl">
          ```bash theme={null}
          # 1. Proposer au modèle un tool de recherche Exa et le laisser choisir la query.
          ...
          # 2. Exécuter le tool call sur Exa.
          ...
          # 3. Transmettre les résultats au modèle pour la réponse finale.
