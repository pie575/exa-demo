...
description: "Un puissant outil de recherche web conçu pour les agents. Tout est optimisé pour vous fournir des résultats précis et économes en jetons."
mode: "wide"
timestamp: false
...
export const ApiCards = ({only}) => {
  ...
  const cards = [{
    ...
    alt: "Champ de recherche Exa affichant des résultats web classés et leurs domaines sources"
  }, {
    id: "agent",
    title: "Agent",
    ...
    id: "contents",
    title: "Contents",
    body: "Texte intégral, highlights et résumés de n’importe quelle URL",
    ...
    <div className="docs-home-try-grid">
      ...
      <div className="docs-home-pane">
        ...
        <div className="docs-home-code" data-pane="tools-curl">
          ...
          # 2. Exécuter l'appel d'outil sur Exa.
