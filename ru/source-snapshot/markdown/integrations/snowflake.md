...
Используйте Search API от Exa прямо из Snowflake, чтобы обогащать свои данные актуальными сведениями из веба — не покидая SQL.
...
| `include_domains`      | `STRING`  | `NULL`       | Домены через запятую, которыми ограничивается выдача                                        |
...
| ------------- | ------------------------------------------------------------------------------------------- |
| `5`           | Консервативный вариант — с большим запасом укладывается в лимиты                            |
...
После создания откройте Snowflake Intelligence и попробуйте задать своему агенту такие вопросы:

* &quot;Найди в интернете свежие фреймворки для AI-агентов&quot;
...
Предоставьте доступ дополнительным пользователям:
