...
> Текущая доступность, активные инциденты и история бесперебойной работы сервисов Exa.
...
Оформите подписку на странице статуса, чтобы получать уведомления о том, что инцидент открыт, обновлён или устранён. Уведомления приходят по электронной почте, в Slack, Google Chat или через вебхук.

<div id="get-help">
  ## Получить помощь
</div>

Если запросы продолжают завершаться ошибкой, хотя все системы работают в штатном режиме, причина, скорее всего, на уровне самого запроса — сначала проверьте [Коды ошибок](/ru/docs/admin/error-codes).

<Columns cols={2}>
  <Card title="Поддержка по почте" icon="mail" href="mailto:hello@exa.ai" cta="Написать в поддержку" arrow="true">
    Для быстрой диагностики укажите статус ответа, тело ошибки и `requestId`.
  </Card>

  <Card title="Поддержка для Enterprise" icon="headset" href="https://exa.ai/contact/sales" cta="Связаться с отделом продаж" arrow="true">
    SLA по бесперебойной работе и поддержке доступны в планах Enterprise.
  </Card>
</Columns>