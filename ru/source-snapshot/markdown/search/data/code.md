...
Используйте Exa Search для поиска репозиториев, технической документации, информации о пакетах и рекомендаций по реализации с помощью запросов на естественном языке.
...
<Card title="Запустить задачу Agent" icon="bot" href="/ru/docs/agent/quickstart" cta="Открыть руководство по Agent" arrow="true">
  Сравнивайте библиотеки, обогащайте записи о репозиториях или формируйте структурированный список на основе нескольких технических сигналов.
</Card>