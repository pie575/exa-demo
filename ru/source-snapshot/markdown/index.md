...
<div id="start-building-with-exa">
  # Начните разработку с Exa
</div>

> Мощный инструмент web search, созданный для агентов. Всё оптимизировано так, чтобы вы получали точные результаты при экономном расходе токенов.
...
export const ApiCards = ({only}) => {
  ...
  const cards = [{
    id: "search",
    title: "Search",
    body: "Данные в реальном времени с опорой на источники и экономичным использованием токенов для содержимого страниц",
    href: "/search/quickstart",
    image: "/images/home/api-search.webp",
    alt: "Строка поиска Exa с ранжированными веб-результатами и доменами их источников"
  }, {
    id: "agent",
    title: "Agent",
    body: "Асинхронные агенты для глубоких исследований, составления списков и enrichment",
    href: "/agent/quickstart",
    image: "/images/home/api-agent.webp",
    alt: "Таблица компаний, дополненная данными о партнёрствах, историях клиентов и использовании облачных сервисов"
  }, {
    id: "search-deep",
    title: "Deep Search",
    body: "Search, анализирующий данные из разных источников и возвращающий структурированный результат",
    href: "/search/deep-search",
    image: "/images/home/api-search-deep.webp",
    alt: "Запрос Deep Search, возвращающий структурированный JSON о биотехнологических компаниях"
  }, {
    id: "contents",
    title: "Contents",
    body: "Полный текст, highlights и сводки по любому URL",
    href: "/contents/quickstart",
    image: "/images/home/api-contents.webp",
    alt: "Извлечённое содержимое страницы Wikipedia о Boeing"
  }, {
    id: "monitors",
    title: "Monitors",
    body: "Запланированные поиски, отслеживающие веб и отправляющие новые результаты",
    href: "/monitors/quickstart",
    image: "/images/home/api-monitors.webp",
    alt: "Монитор Anthropic Releases and News, запускаемый ежедневно",
    hidden: true
  }];
...
<div className="docs-home">
  <a className="docs-home-llms" href="/ru/docs/llms.txt">
    Если вы LLM, прочитайте <span className="docs-home-llms-word">LLMs.txt</span>
  </a>
  ...
  <div className="docs-home-quickstart">
    ...
    <div className="docs-home-quickstart-copy">
      <span className="docs-home-quickstart-title">Добавьте Exa в свой agent</span>
      <p>Начните меньше чем за минуту</p>
    </div>

    <div className="docs-home-quickstart-actions">
      <a className="docs-home-button" href="/ru/docs/get-started/quickstart">
        Начать
      </a>
  ...
  <div className="docs-home-try">
    ...
    <div className="docs-home-try-grid">
      <h2 className="docs-home-try-title">Примеры</h2>

      <div className="docs-home-langs" role="tablist" aria-label="Язык">
      ...
      <div className="docs-home-apis" role="tablist" aria-label="API">
        <label htmlFor="docs-home-api-search">Поиск в интернете</label>
        <label htmlFor="docs-home-api-contents">Получение содержимого страницы</label>
        <label htmlFor="docs-home-api-deep">Получение структурированного результата</label>
        <label htmlFor="docs-home-api-tools">Подключение веб-поиска к LLM</label>
        <label htmlFor="docs-home-api-agent">Составление списка на основе исследования</label>
        <label htmlFor="docs-home-api-agent-research">Анализ сложной темы</label>
      </div>
      ...
      <div className="docs-home-pane">
        ...
        <div className="docs-home-code" data-pane="tools-curl">
          ```bash theme={null}
          # 1. Даём модели инструмент Exa search и позволяем ей самой выбрать запрос.
          ...
          # 2. Выполняем вызов инструмента к Exa.
          ...
          # 3. Возвращаем результаты модели для получения итогового ответа.
        ...
        <a className="docs-home-pane-link" data-pane-link="search" href="https://dashboard.exa.ai/playground/search?q=companies%20selling%20AI%20voice%20agents%20to%20dental%20practices&filters=%7B%22highlights%22%3Atrue%2C%22numResults%22%3A10%7D">Открыть в playground</a>
        <a className="docs-home-pane-link" data-pane-link="deep" href="https://dashboard.exa.ai/playground/search?q=Who%20is%20Anthropic%27s%20CEO%2C%20when%20was%20the%20company%20founded%2C%20and%20where%20is%20it%20headquartered%3F&filters=%7B%22type%22%3A%22deep%22%2C%22outputSchema%22%3A%7B%22type%22%3A%22object%22%2C%22required%22%3A%5B%22company%22%2C%22ceo%22%2C%22founded_year%22%2C%22headquarters%22%5D%2C%22properties%22%3A%7B%22company%22%3A%7B%22type%22%3A%22string%22%7D%2C%22ceo%22%3A%7B%22type%22%3A%22string%22%7D%2C%22founded_year%22%3A%7B%22type%22%3A%22number%22%7D%2C%22headquarters%22%3A%7B%22type%22%3A%22string%22%7D%7D%7D%7D">Открыть в playground</a>
        <a className="docs-home-pane-link" data-pane-link="tools" href="/ru/docs/integrations/tool-calling/openai">Читать руководство</a>
        <a className="docs-home-pane-link" data-pane-link="agent" href="https://dashboard.exa.ai/playground/agent?q=Find%2010%20seed-stage%20companies%20building%20infrastructure%20for%20AI%20coding%20agents.">Открыть в playground</a>
        <a className="docs-home-pane-link" data-pane-link="agent-research" href="https://dashboard.exa.ai/playground/agent?q=Analyze%20how%20the%20EU%20AI%20Act%20affects%20startups%20selling%20AI%20products%20in%20Europe.%20Cover%20key%20dates%2C%20obligations%2C%20and%20practical%20risks%2C%20citing%20official%20sources.">Открыть в playground</a>
        <a className="docs-home-pane-link" data-pane-link="contents" href="https://dashboard.exa.ai/playground/get-contents?filters=%7B%22ids%22%3A%5B%22https%3A%2F%2Fwww.anthropic.com%2Fpricing%22%5D%2C%22highlights%22%3A%7B%22query%22%3A%22enterprise%20plan%20features%20and%20pricing%22%7D%7D">Открыть в playground</a>
      </div>
    </div>
  </div>

  <h2 className="docs-home-section">Доступные API</h2>
