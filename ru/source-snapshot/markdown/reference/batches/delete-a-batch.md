...
> Удаление пакета, находящегося в терминальном статусе.

При удалении пакет исчезает из истории пакетов вашей команды. Удалить можно только пакеты в терминальном статусе.
