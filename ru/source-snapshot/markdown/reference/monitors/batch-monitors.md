...
> Используйте этот файл, чтобы найти все доступные страницы, прежде чем изучать документацию дальше.

<div id="batch-action-on-monitors">
  # Пакетное действие над monitor&#39;ами
</div>

> Выполните пакетное действие над monitor&#39;ами, соответствующими заданным фильтрам.

Поддерживаемые действия:

* **delete**: безвозвратно удалить подходящие monitor&#39;ы
* **pause**: приостановить подходящие monitor&#39;ы
* **unpause**: возобновить подходящие monitor&#39;ы

Используйте `dry_run: true` (значение по умолчанию), чтобы перед выполнением действия посмотреть, какие monitor&#39;ы будут затронуты. Результаты разбиваются на страницы с помощью параметра `limit`; повторяйте запросы в цикле, пока `has_more` не станет `false`, чтобы обработать все подходящие monitor&#39;ы.
