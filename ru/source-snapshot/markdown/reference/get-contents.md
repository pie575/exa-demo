...
> Получение полного содержимого страниц, сводок и метаданных для списка URL.

Возвращает мгновенные результаты из нашего кэша, а для страниц, которых в кэше нет, автоматически выполняет live-краулинг.
