...
> Удаляет вебхук. Его статус меняется на `inactive`, и дальнейшая доставка вебхук-сообщений на его URL прекращается.
...
paths:
  /v0/webhooks/{id}:
    ...
    delete:
      ...
      description: >-
        Удаляет вебхук. Его статус становится `inactive`, что прекращает будущие
        доставки вебхуков на его URL.
