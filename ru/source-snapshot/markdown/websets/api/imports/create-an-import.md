...
* **Обогащать**: дополнять данные новой информацией с помощью нашего движка enrichment на базе ИИ
* **Искать**: выполнять запросы к вашим данным через агентный search в Websets с фильтрами на естественном языке
* **Исключать**: не допускать попадания дубликатов или уже известных результатов в результаты поиска
