...
<div id="list-all-items-for-a-webset">
  # Получение списка всех элементов webset
</div>

> Возвращает список элементов Webset.

Для постраничного перебора элементов используйте параметр `cursor`.
...
paths:
  /v0/websets/{webset}/items:
    ...
    get:
      tags:
        - Items
      summary: Список всех Items для Webset
      description: |-
        Возвращает список Items указанного Webset.
