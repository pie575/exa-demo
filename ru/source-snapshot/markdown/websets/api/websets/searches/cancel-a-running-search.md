...
> </div>
>
> Полное оглавление документации доступно по адресу: https://exa.ai/docs/llms.txt
> Используйте этот файл, чтобы ознакомиться со всеми доступными страницами, прежде чем приступать к дальнейшему изучению.
...
Отменить все поиски сразу можно с помощью эндпоинта `websets/:webset/cancel`.
