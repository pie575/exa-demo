...
<div id="create-a-websets-monitor">
  # Создание monitor для Websets
</div>

> Создаёт новый `Monitor`, который непрерывно поддерживает ваши Websets в актуальном состоянии, обновляя их свежими данными.

Monitors запускаются автоматически по заданному вами расписанию, благодаря чему ваши Websets остаются актуальными без ручного вмешательства:

* **Поиск нового контента**: выполняйте операции `search`, чтобы находить новые items, соответствующие вашим criteria
* **Обновление существующего контента**: выполняйте операции `refresh`, чтобы обновлять contents и enrichments у items
* **Автоматическое расписание**: задавайте выражения `cron` и `timezone` для точного управления расписанием
