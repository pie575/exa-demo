---
title: "Начните разработку с Exa"
sidebarTitle: "Обзор"
description: "Мощный инструмент веб-поиска, созданный для агентов. Всё оптимизировано так, чтобы вы получали точные результаты с экономным расходом токенов."
mode: "wide"
timestamp: false
...
export const ApiCards = ({only}) => {
  ...
  const cards = [{
    id: "search",
    title: "Search",
    body: "Актуальные данные с привязкой к источникам и экономичным расходом токенов",
    href: "/docs/search/quickstart",
    image: "/docs/images/home/api-search.webp",
    alt: "Окно поиска Exa с ранжированными веб-результатами и доменами их источников"
  }, {
    id: "agent",
    title: "Agent",
    ...
    alt: "Таблица компаний с данными о партнёрствах, историях клиентов и использовании облачных сервисов"
  }, {
    id: "search-deep",
    title: "Глубокий поиск",
    body: "Поиск, который сопоставляет данные из разных источников и возвращает структурированный результат",
    href: "/docs/search/deep-search",
    image: "/docs/images/home/api-search-deep.webp",
    alt: "Запрос глубокого поиска, возвращающий структурированный JSON о биотехнологических компаниях"
  }, {
    id: "contents",
    title: "Contents",
...
<div className="docs-home">
  <a className="docs-home-llms" href="/ru/docs/llms.txt">
    Если вы LLM, читайте <span className="docs-home-llms-word">LLMs.txt</span>
  </a>
  ...
  <div className="docs-home-quickstart">
    ...
    <div className="docs-home-quickstart-copy">
      <span className="docs-home-quickstart-title">Добавьте Exa в своего агента</span>
      <p>Начните менее чем за минуту</p>
    </div>
  ...
  <div className="docs-home-try">
    ...
    <div className="docs-home-try-grid">
      ...
      <div className="docs-home-apis" role="tablist" aria-label="API">
        ...
        <label htmlFor="docs-home-api-deep">Получение структурированных данных</label>
        <label htmlFor="docs-home-api-tools">Веб-поиск для LLM</label>
      ...
      <div className="docs-home-pane">
        ...
        <div className="docs-home-code" data-pane="tools-curl">
          ```bash theme={null}
          # 1. Предоставьте модели инструмент поиска Exa и дайте ей самой выбрать запрос.
          ...
          # 2. Выполните вызов инструмента к Exa.
          ...
          # 3. Передайте результаты обратно модели для получения итогового ответа.
