...
sidebarTitle: "Научные публикации"
icon: "book-open"
description: "Находите научные статьи, патенты, гранты, клинические исследования и разрешения регуляторов с помощью Exa Search."
---
...
Используйте Exa Search для поиска научных публикаций и связанных с ними записей: названий, аннотаций, авторов, изданий, цитирований, страниц издательств, препринтов и страниц репозиториев.
...
* Научные статьи и препринты, в том числе фрагменты полного текста, если доступен распознанный полный текст
...
* Клинические исследования, инструкции к препаратам и данные о лекарственных взаимодействиях
* Разрешения регулятора и разрешения в сфере здравоохранения
...
* Поиск грантов и возможностей финансирования
...
<div id="find-papers-on-a-topic">
  ### Поиск научных статей по теме
</div>

Опишите метод или результат, а не пытайтесь угадать ключевые слова в заголовке. Категория `publication` оставляет в выдаче только научные статьи.
...
Укажите фазу, вмешательство и популяцию — тогда записи в реестрах исследований и страницы с результатами окажутся выше общих публикаций.
...
<div id="run-a-prior-art-search">
  ### Поиск по предшествующему уровню техники
</div>

Описывайте изобретение функционально, как в патентной формуле, а не через название продукта.
...
Если для получения структурированных данных нужно исследование по нескольким источникам, используйте [запуск задачи Exa Agent](/ru/docs/agent/quickstart). Опишите публикации, критерии включения и нужные поля вывода — Agent вернёт результаты, проверенные по схеме, вместе со ссылками на источники.

<Card title="Запустить задачу Agent" icon="bot" href="/ru/docs/agent/quickstart" cta="Открыть руководство по Agent" arrow="true">
  Постройте карту литературы, отберите научные статьи по критериям включения или соберите поля из нескольких публикаций в одну таблицу.
</Card>