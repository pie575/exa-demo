...
sidebarTitle: "Обзор"
icon: "database"
description: "Что Exa индексирует в открытом вебе и в приватных источниках данных."
---
...
Exa ищет по открытому вебу и отдельным закрытым источникам данных, непрерывно обновляя охват. Сюда входят:
...
<AccordionGroup>
  <Accordion title="Новости" icon="newspaper">
    <Card title="Руководство по новостям" icon="newspaper" href="/ru/docs/search/data/news" cta="Читать руководство" arrow="true">
      Изучите сценарии использования поиска по новостям, примеры и рекомендации.
    </Card>
  ...
  <Accordion title="Код и документация" icon="code">
    <Card title="Руководство по коду и документации" icon="code" href="/ru/docs/search/data/code" cta="Читать руководство" arrow="true">
      Познакомьтесь со сценариями поиска по коду, примерами и рекомендациями.
    </Card>
  ...
  <Accordion title="Компании и люди" icon="users">
    ...
    Исследование компаний и их ключевых сотрудников в одном запросе:
  ...
  <Accordion title="Финансовые рынки" icon="chart-line">
    <Card title="Руководство по финансовым рынкам" icon="chart-line" href="/ru/docs/search/data/financial" cta="Читать руководство" arrow="true">
      Изучите сценарии использования: котировки, отчётность, звонки с инвесторами и рыночная аналитика.
    </Card>
    ...
    Отчёты в SEC, звонки с инвесторами и отчётность зарубежных регуляторов:

    <PlaygroundQuery query="10-K risk factors that mention dependency on third-party AI models" />

    Объявленные раунды финансирования и другие публично раскрываемые данные:
  ...
  <Accordion title="Научные публикации" icon="book-open">
    <Card title="Руководство по научным публикациям" icon="book-open" href="/ru/docs/search/data/research" cta="Читать руководство" arrow="true">
      Разберём сценарии использования для научных статей, патентов, клинических и регуляторных исследований.
    </Card>
    ...
    Клинические испытания и лекарственные взаимодействия:

    <PlaygroundQuery query="phase 3 trials of GLP-1 agonists in adolescent patients" />

    Регуляторные и медицинские одобрения:

    <PlaygroundQuery query="FDA approvals for AI-based diagnostic devices" />
  </Accordion>

  <Accordion title="Юридические и публичные реестры" icon="scale">
    ...
    Переписи населения и другие публичные данные:
  ...
  <Accordion title="Спорт, погода и места" icon="map-pin">
    ...
    Текущие счета, турнирные таблицы и расписания матчей:

    <PlaygroundQuery query="NBA scores last night" />

    Прогнозы погоды для любого места и на любую дату:

    <PlaygroundQuery query="weather in San Francisco tomorrow" />

    Местные заведения, площадки и объекты недвижимости:
  ...
  <Accordion title="Кибербезопасность" icon="shield">
    <Card title="Руководство по кибербезопасности" icon="shield" href="/ru/docs/search/data/security" cta="Читать руководство" arrow="true">
      Изучите сценарии работы с уязвимостями, бюллетенями безопасности и рисками поставщиков.
    </Card>
    ...
    Базы данных уязвимостей CVE и GHSA:

    <PlaygroundQuery query="critical CVEs affecting Apache Struts 6.x" />

    Списки субобработчиков данных и trust-страницы:

    <PlaygroundQuery query="subprocessor lists for SOC 2 compliant CRM vendors" />
  </Accordion>
</AccordionGroup>

Эти руководства охватывают распространённые сценарии работы с данными, но Exa также ищет по всему открытому вебу — множеству сайтов, форматов и языков.