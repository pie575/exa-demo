...
> Hentikan run Agent yang sedang berjalan secara halus dan simpan hasil yang sudah terkumpul.
...
<Note>
  ...
  dikirim sebagai header permintaan. Header ini menerima daftar token beta yang dipisahkan koma.
</Note>
