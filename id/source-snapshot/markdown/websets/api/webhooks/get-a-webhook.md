...
# Mendapatkan webhook {#get-a-webhook}

> Mengembalikan Webhook berdasarkan id, termasuk status, events yang dilanggan, URL target, dan metadata. `secret` penandatanganan tidak dikembalikan.
