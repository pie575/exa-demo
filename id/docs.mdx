...
description: "Tool web search andal yang dirancang untuk agent. Semuanya dioptimalkan agar Anda memperoleh hasil yang akurat dan hemat token."
mode: "wide"
timestamp: false
...
export const ApiCards = ({only}) => {
  ...
  const cards = [{
    ...
    alt: "Kotak pencarian Exa dengan hasil web berperingkat beserta domain sumbernya"
  }, {
    id: "agent",
    title: "Agent",
    ...
    id: "search-deep",
    title: "Deep Search",
    body: "Search yang bernalar lintas sources dan menghasilkan output terstruktur",
