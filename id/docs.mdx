---
title: "Mulai membangun dengan Exa"
sidebarTitle: "Ikhtisar"
description: "Alat web search andal yang dirancang untuk agent. Semuanya dioptimalkan agar Anda mendapatkan hasil yang akurat dan hemat token."
mode: "wide"
timestamp: false
...
export const ApiCards = ({only}) => {
  ...
  const cards = [{
    ...
    alt: "Kotak pencarian Exa dengan hasil web yang diurutkan berdasarkan peringkat dan domain sumbernya"
  }, {
    id: "agent",
    title: "Agent",
    body: "Agent asinkron untuk riset mendalam, penyusunan daftar, dan enrichment",
    href: "/docs/agent/quickstart",
    image: "/docs/images/home/api-agent.webp",
    alt: "Spreadsheet perusahaan yang diperkaya dengan data kemitraan, kisah pelanggan, dan penggunaan cloud"
  }, {
    id: "search-deep",
    title: "Deep Search",
    body: "Search yang menalar lintas sumber dan menghasilkan output terstruktur",
    ...
    alt: "Konten halaman Wikipedia tentang Boeing yang diekstrak"
  }, {
    id: "monitors",
    title: "Monitors",
    body: "Search terjadwal yang memantau web dan mengirimkan hasil baru",
  ...
  <div className="docs-home-try">
    ...
    <div className="docs-home-try-grid">
      ...
      <div className="docs-home-apis" role="tablist" aria-label="API">
        ...
        <label htmlFor="docs-home-api-agent">Susun daftar berbasis riset</label>
        <label htmlFor="docs-home-api-agent-research">Analisis topik kompleks</label>
      </div>
      ...
      <div className="docs-home-pane">
        ...
        <div className="docs-home-code" data-pane="tools-curl">
          ```bash theme={null}
          # 1. Sediakan tool Exa search untuk model dan biarkan model yang menentukan query-nya.
          ...
          # 3. Kembalikan hasilnya ke model untuk jawaban akhir.
