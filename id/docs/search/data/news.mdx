...
sidebarTitle: "Berita"
icon: "newspaper"
description: "Temukan pemberitaan terbaru, liputan industri, dan isu yang sedang berkembang dengan Exa Search."
---
...
Gunakan Exa Search untuk pemberitaan dari media besar, pers industri, dan media niche. Artikel baru bisa ditemukan lewat pencarian dalam hitungan menit setelah terbit. Gabungkan query berbahasa alami dengan filter tanggal ketika rentang waktu publikasi menjadi syarat mutlak.
...
Sebutkan topik, jenis sumber, dan rentang waktu publikasi agar hasilnya berfokus pada fase terkini dari berita tersebut.
...
<div id="find-practitioner-analysis">
  ### Mencari analisis dari praktisi
</div>
...
Sertakan format dan topiknya di dalam query. Dengan begitu, search tetap mencakup halaman episode dan transcript di seluruh web.
...
Jelaskan sinyal negatifnya sekaligus kelas entitas yang sedang Anda selidiki. Hindari menyederhanakan query menjadi sekadar nama perusahaan ditambah kata &quot;berita&quot;.
...
Untuk data terstruktur yang memerlukan riset lintas berbagai sumber, gunakan [run task Exa Agent](/id/docs/agent/quickstart). Jelaskan berita, field, dan rentang waktu yang Anda butuhkan, lalu Agent akan mengembalikan hasil yang tervalidasi schema beserta citations.

<Card title="Mulai task Agent" icon="bot" href="/id/docs/agent/quickstart" cta="Buka panduan Agent" arrow="true">
  Susun ringkasan berita bersumber jelas, bandingkan liputan, atau ekstrak fakta yang sudah dinormalisasi dari berita yang sedang berkembang.
</Card>