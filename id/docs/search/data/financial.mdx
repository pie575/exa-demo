...
icon: "chart-line"
description: "Temukan data pasar, filings, earnings call, dan rilis data ekonomi dengan Exa Search."
---
...
Gunakan Exa Search untuk harga, filings, transkrip, dan pemberitaan seputar semuanya dalam satu query. Pertanyaan tentang sebuah ticker dapat mengembalikan kuotasi harga, earnings call terbaru, dan liputan analis sekaligus.
...
* Transkrip earnings call, lengkap dengan pernyataan pembuka dan sesi tanya jawab beserta pembicaranya
...
* Screening KYC, KYB, dan adverse media
...
Sebutkan nama perusahaan dan kuartalnya agar yang didapat adalah transkripnya, bukan pemberitaan tentangnya.

<PlaygroundQuery query="Tyson Foods Q4 FY2025 earnings call transcript" />

### Mencari filings {#search-filings}
...
Sebutkan rilis data dan angka yang Anda butuhkan dari rilis tersebut.
...
Untuk data terstruktur yang memerlukan research di berbagai sumber, gunakan [Exa Agent task run](/id/docs/agent/quickstart). Jelaskan sekuritas, period, kriteria, dan output fields yang Anda butuhkan, lalu Agent akan mengembalikan hasil yang tervalidasi terhadap schema beserta sitasi.
