...
icon: "database"
description: "Apa saja yang diindeks Exa di seluruh public web dan sumber data privat."
---
...
Exa menelusuri public web serta sejumlah sumber data privat pilihan, dengan cakupan yang terus diperbarui. Cakupan ini meliputi:
...
<AccordionGroup>
  ...
  <Accordion title="Kode & Dokumentasi" icon="code">
    ...
    Registri package, lengkap dengan detail versi dan rilis yang presisi:
  ...
  <Accordion title="Pasar Keuangan" icon="chart-line">
    <Card title="Panduan Financial Markets" icon="chart-line" href="/id/docs/search/data/financial" cta="Baca panduan" arrow="true">
    ...
    Pendanaan yang diumumkan dan data lain yang dilaporkan ke publik:
  ...
  <Accordion title="Publikasi Research" icon="book-open">
  ...
  <Accordion title="Olahraga, Cuaca & Lokasi" icon="map-pin">
    <Card title="Panduan Olahraga, Cuaca & Tempat" icon="map-pin" href="/id/docs/search/data/sports-weather-places" cta="Baca panduan" arrow="true">
      Pelajari cara melakukan query untuk data olahraga langsung, prakiraan cuaca, dan informasi lokal.
    </Card>
...
Panduan ini membahas pola data yang umum, tetapi Exa juga melakukan pencarian di public web yang lebih luas, mencakup banyak situs, format, dan bahasa.