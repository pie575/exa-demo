...
<Steps>
  <Step title="Prasyarat dan instalasi">
    Pasang library crewAI core, crewAI tools, dan Exa Python SDK.
  ...
  <Step title="Menyiapkan agent crewAI">
    Impor modul crewAI yang relevan. Kemudian, definisikan `exa_tools` untuk merujuk ke metode search kustom yang telah kita definisikan di atas.
  ...
  <Step title="Menentukan tugas untuk agent">
    Selanjutnya, kita akan mendefinisikan [task](https://docs.crewai.com/concepts/Tasks/) untuk setiap agent dan membangun crew secara keseluruhan dengan semua komponen yang sudah kita siapkan di atas.
