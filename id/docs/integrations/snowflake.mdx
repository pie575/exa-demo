---
title: "Snowflake"
description: "Gunakan Exa search dan pengambilan konten dari stored procedure Snowflake dan Cortex Agent."
icon: "/docs/images/sidebar-icons/snowflake.svg"
---

Gunakan Search API Exa langsung dari Snowflake untuk memperkaya data Anda dengan informasi web terkini — tanpa perlu keluar dari SQL.
...
* Sebuah **external access integration** yang menggabungkan rule dan secret tersebut
...
Melakukan pencarian di web menggunakan Search API dari Exa. Mengembalikan hasil berisi judul, URL, skor, dan secara opsional teks/highlights/summaries.
...
| `include_domains`      | `STRING`  | `NULL`   | Daftar domain dipisahkan koma sebagai batasan hasil                                          |
| `exclude_domains`      | `STRING`  | `NULL`   | Daftar domain dipisahkan koma yang dikecualikan                                              |
...
Saat melakukan enrich pada tabel berukuran besar, memanggil Exa satu per satu untuk setiap baris akan lambat. Anda dapat memparalelkan permintaan menggunakan `concurrent.futures` Python di dalam satu stored procedure, sehingga beberapa panggilan API Exa dikirim sekaligus.

<div id="concurrent-enrichment-procedure">
  ### Prosedur enrichment konkuren
</div>
...
| `10`          | Nilai default yang baik untuk sebagian besar pekerjaan enrichment              |
...
Anda juga dapat mendaftarkan stored procedure Exa sebagai tool untuk [Snowflake Cortex Agent](https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-agents), sehingga agent tersebut dapat melakukan pencarian web melalui percakapan.
...
Setelah dibuat, buka Snowflake Intelligence dan coba tanyakan hal berikut ke agent Anda:

* &quot;Cari di web tentang framework AI agent terbaru&quot;
* &quot;Temukan paper penelitian tentang retrieval augmented generation&quot;
* &quot;Apa saja perusahaan AI teratas yang patut diperhatikan?&quot;
...
| Lapisan                         | Detail                                                                   |
| ------------------------------- | ------------------------------------------------------------------------ |
| **Roles**                       | `exa_agent_role` untuk akses terbatas ke prosedur dan data               |
...
* [Dokumentasi API Exa](/id/docs/search/quickstart)
