---
title: "Status Page"
description: "Ketersediaan layanan secara real-time, incident aktif, dan riwayat uptime untuk layanan Exa."
...
Exa memublikasikan ketersediaan layanan di [status.exa.ai](https://status.exa.ai): status terkini Search API, Websets, dan Exa MCP, incident aktif beserta pembaruannya seiring perkembangan, serta riwayat uptime selama 90 hari terakhir.
...
<Columns cols={2}>
  <Card title="Dukungan email" icon="mail" href="mailto:hello@exa.ai" cta="Kirim email ke dukungan" arrow="true">
    Kirimkan status response, error body, dan `requestId` agar diagnosis bisa dilakukan secepat mungkin.
  </Card>
