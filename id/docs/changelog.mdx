...
<Update label="August 28, 2026" rss={{ title: "Dynamic Highlights (research preview)" }}>
  ## Dynamic Highlights (pratinjau Research) {#dynamic-highlights-research-preview}
...
<Update label="March 4, 2026" rss={{ title: "Exa Deep Revamp" }}>
  ## Exa Deep Revamp {#exa-deep-revamp}
...
<Update label="March 3, 2026" rss={{ title: "Exa Pricing Update" }}>
  ## Exa Pricing Update {#exa-pricing-update}
...
<Update label="February 2, 2026" rss={{ title: "Highlights, content freshness, dan pembaruan MCP" }}>
  ## Highlights, content freshness, dan pembaruan MCP {#highlights-content-freshness-and-mcp-updates}
...
<Update label="November 5, 2025" rss={{ title: "Pemfilteran Bahasa Ditambahkan" }}>
  ## Pemfilteran Bahasa Ditambahkan {#added-language-filtering}
...
<Update label="July 29, 2025" rss={{ title: "New Fast Search Type" }}>
  ## Search Type Fast yang Baru {#new-fast-search-type}
...
<Update label="June 23, 2025" rss={{ title: "Markdown Contents as Default" }}>
  ## Markdown sebagai Default untuk Contents {#markdown-contents-as-default}
...
<Update label="May 22, 2025" rss={{ title: "Contents Endpoint Status Changes" }}>
  ## Perubahan Status pada Endpoint Contents {#contents-endpoint-status-changes}
