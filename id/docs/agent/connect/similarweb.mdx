...
[Similarweb](https://www.similarweb.com) adalah salah satu sumber utama intelijen
pasar digital. Similarweb memodelkan trafik dan engagement jutaan situs web
serta aplikasi, mencakup estimasi kunjungan, sumber trafik, demografi audiens, dan
...
Similarweb berdampingan dengan Exa web search.

<div id="use-it-for">
  ## Gunakan untuk
</div>

* Membandingkan trafik web dan tingkat keterlibatan sebuah perusahaan dengan para pesaingnya.
* Memetakan kompetitor sebuah domain dan situs-situs yang audiensnya beririsan.
...
Similarweb menagih dalam bentuk data credit seharga `$0.30 / credit`, dan setiap call
dikenakan credit sesuai yang dilaporkan Similarweb untuk call tersebut. Jumlah credit
mengikuti banyaknya data yang dikembalikan — kira-kira satu credit per titik data (metrik × baris × bulan) — sehingga harga sebuah call
ditentukan oleh parameternya:
...
| Top keywords          | 1–10 (sekitar 1 per 100 titik data kata kunci; 50 kata kunci sekitar ~7) |
...
Call yang tidak mengembalikan data (domain yang tidak dikenal atau trafik rendah, kata kunci tanpa
volume pencarian) tidak dikenakan biaya. `numResults` dan `months` menentukan berapa banyak titik data yang Anda
bayar, jadi buat nilainya sekecil mungkin sesuai kebutuhan tugas Anda.
