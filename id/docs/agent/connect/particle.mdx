---
title: "Particle"
description: "Cari transcript podcast dengan atribusi pembicara dan timestamp."
...
yang ditranskripsi penuh, didiarisasi, diidentifikasi pembicaranya, dilabeli, dan diperkaya dengan metadata
dalam hitungan menit setelah tayang, sehingga percakapan lisan dapat dicari. Setiap hasil berupa
potongan transcript beratribusi pembicara yang dilengkapi timestamp.
...
* Menemukan komentar pakar dan kutipan yang layak dikutip.
* Pemantauan media dan merek.
* Riset narasi dan sentimen.
* Menemukan podcast baru dan mengikuti perkembangannya.
...
* [Fiber.ai](/id/docs/agent/connect/fiber): lampirkan konteks perusahaan dan kontak untuk orang-orang yang sedang dibahas.
