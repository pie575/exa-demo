...
Gunakan skill ini untuk mengajari agent Anda memanggil Exa Search melalui cURL atau raw HTTP dengan praktik terbaik.
...
<Card title="exa-search/SKILL.md" icon="file-code" href="https://raw.githubusercontent.com/exa-labs/agent-skills/main/skills/exa-search/SKILL.md" cta="Lihat sumber" arrow="true">
  Baca definisi skill exa-search sebelum menginstalnya.
</Card>
